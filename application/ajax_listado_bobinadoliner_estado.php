 ...
 if($this->session->userdata('id'))
        {
            ...
            $porpagina=10;
			$datos=$this->produccion_model->getBobinadoLinerEstadoConCotizacionPaginacion($pagina,$porpagina,"limit");
			$cuantos=$this->produccion_model->getBobinadoLinerEstadoConCotizacionPaginacion($pagina,$porpagina,"cuantos");
...
//prioridad	fch lib selección liner	numero orde	cliente	detalle	fecha OP	descrip cartulina	gramaje 	ancho a bobinar	largo a cortar	cantidad pliegos	kilos	tiene entregas parciales?	vendedor	estado

?>
<div class="page-header"><h3>Listado de Producción Bobinado Liner Estado( <?php echo sizeof($datos)?> en total)</h3></div>
<table class="table table-bordered table-striped indice">
	<thead>
		<tr>
              
               <th>Prioridad</th>
			   <th>Fecha Liberacion Control Liner</th>
			   <th>Número Orden</th>
			   <th>Cliente</th>
			   <th>Detalle</th>			   
			   <th>Fecha OP</th>
...
$control_liner=$this->produccion_model->getControlLiner($dato->id_nodo);
		
    ?>
       <td style="width: 20px;">Prioridad</td>
		<td style="width: 20px;"><?php echo $control_liner->cuando?></td>
