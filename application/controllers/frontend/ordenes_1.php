...
class Ordenes extends CI_Controller {
    ...
    public function add($id=null,$pagina=null)
    {
        ...
        $cliente_arreglo=$this->clientes_model->getClientePorIdSinJoin($datos->id_cliente);
...
//                     echo $id_molde; exit();
        ...
        $this->layout->view('add',compact("datos","id","pagina","impresionPresupuesto","orden","ordenDeCompra","ing","productos","hoja","fotomecanica","vendedor","codigoNuevo","existeProducto","existeProducto2","proveedores","orden_compra_piezas","empresa","usuarios","orden_de_compra","cliente_arreglo")); 
        }else
        {
            redirect(base_url().'usuarios/login',  301);
        }
...
//                    exit("paso2");                    
    ...
    public function ajax_obtener_estatus_cliente()
    {
        ...
        $this->load->library('javascript', array('js_library_driver' => 'scripto', 'autoload' => FALSE));
        $this->layout->setLayout('template_ajax');
        $rut=$this->input->post("valor",true); // porción1
