...
<!-- Migas -->
    <ol  class= "breadcrumb" >  
      ...
      <li>Resultados para Productos de tipo : <?php if($id==1){echo 'Normal';}else{echo 'Genéricos';}?></li>
    </ol>
   <!-- /Migas -->
<div class="page-header"><h3>Resultados para Productos de tipo : <?php if($id==1){echo 'Normal';}else{echo 'Genéricos';}?></h3></div>
<!--tipo-->
