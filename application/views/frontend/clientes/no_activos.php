...
<!-- Migas -->
    <ol  class= "breadcrumb" >  
      ...
      <li>Cliente No Activos</li>
    </ol>
   <!-- /Migas -->
<div class="page-header"><h3>Clientes No Activos ( <?php echo $cuantos?> en total)</h3></div>
		...
		<div class="controls">
			<select name="perfil" onchange="enviaSelect('clientes',this.value);">
                <option value="0">Seleccione.....</option>
                  ...
                  <option value="3" selected="selected">No Activos</option>
            </select>
		</div>
	</div>
</div>
