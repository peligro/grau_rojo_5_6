...
<?php echo form_open_multipart(null, array('class' => 'form-horizontal','name'=>'form','id'=>'form')); ?>
    ...
    <div class="control-group">
		<label class="control-label" for="usuario">Valor Empresa <?php echo $valor?></label>
		<div class="controls">
			<input type="text" name="valor" value="<?php echo $cantidad?>" onkeypress="return soloNumeros(event)" />
		</div>
	</div>
     <div class="control-group">
