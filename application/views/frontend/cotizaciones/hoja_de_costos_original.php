...
//                                }
            ...
            if($fotomecanica->estan_los_moldes == 'NO LLEVA')
	    {
           ...
           $totalEmplacado4=$valorEmplacadado*$costoOnda4."<br>";
                     ...
                     echo   "--sospe-->".$dos=($datos->cantidad_2/$ing->unidades_por_pliego)+$sum2."<br />";
                            ...
                            echo "D".$tamano1."D<br>";
                            echo "E".$tamano2."E<br>";
                            echo "F".$GramosMetroCuadrado."F<br>";
                            echo "A".$costo_kilo."G<br>-----------------";
                            ...
                            echo "--->".$totalPlacaKilo2=$valorPlacaKilo2*$materialidad_1->precio."<br />";
                           ...
                           echo "<h1>---->$totalDefi1</h1>";
                         
                            echo "<br>B".$totalPlacaKilo2."B<br>";
                            echo "C".$v2."C<br>";
                            echo "D".$tamano1."D<br>";
                            echo "E".$tamano2."E<br>";
                            echo "F".$GramosMetroCuadrado."F<br>";
...
//                            echo $valor_acepeta_exce."ww<br>";
                            ?>
                        <table id="tabla_detalle" border="1">
                            <tr><td>Materia Prima * cantidad</td>
                                <td><?php echo number_format($totalDefi1,0,"",".") ?></td>
                                <td><?php echo number_format($datos->cantidad_2,0,"",".") ?></td>
                            </tr>
                            <tr><td>Pre Impresion * cantidad</td>
                                <td><?php echo number_format($totalPreImpresion,0,"",".") ?></td>
                                <td><?php echo number_format($datos->cantidad_2,0,"",".") ?></td>
                            </tr>
                            <tr><td>Total Produccion * cantidad</td>
                        ...
                        <table id="tabla_detalle">
							...
							<?php 
//                                                        echo "AQUIIIIIIIIIII"."<br>";
//                                                        echo $totalProduccion2."<br>";
//                                                        echo $totalDefi1."<br>";
//                                                        echo $totalPreImpresion."<br>";
//                                                        echo $datos->cantidad_2."<br>";
							?>
				...
				if(sizeof($hoja)==0)
                            ...
                            <?php
//                              echo "<h1>AQUIIIIIIII</h1>".$valorEmpresa2=$hoja->valor_empresa_2."<br />";
//                                    echo $valorEmpresa3=$hoja->valor_empresa_3."<br />";
//                                    echo $valorEmpresa4=$hoja->valor_empresa_4."<br />";
//                                    echo $datos->cantidad_2."<br />";
//                                    echo $valorEmpresa2."<br />";
//                                    echo $valorFinanciado2."<br />";
//                                    echo $vfinanciero2."<br />";
                            ?>
...
<!--                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>50</td>
                                            <td>primeros 1.000</td>
                                            <td><?php echo $emplacado_fijo2?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td><?php echo $emplacado_merma?></td>
 ...
 <tr>
                                            ...
                                            <td>40</td>
                                            <td>Los primeros 1.000</td>
                                            <td><?php echo $troquelado_fijo2 ?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td><?php echo $troquelado_merma ?></td>
...
<!--                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>50</td>
                                            <td>primeros 1.000</td>
                                            <td><?php echo $emplacado_fijo3?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td><?php echo $emplacado_merma?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>40</td>
                                            <td>Los primeros 1.000</td>
                                            <td><?php echo $troquelado_fijo3 ?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td><?php echo $troquelado_merma ?></td>
...
<!--                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>50</td>
                                            <td>primeros 1.000</td>
                                            <td><?php echo $emplacado_fijo4?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td><?php echo $emplacado_merma?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>40</td>
                                            <td>Los primeros 1.000</td>
                                            <td><?php echo $troquelado_fijo4 ?></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td><?php echo $troquelado_merma ?></td>
