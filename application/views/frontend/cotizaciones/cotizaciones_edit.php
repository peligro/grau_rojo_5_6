...
<div id="contenidos">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select name="cliente" onchange="recetear_cliente_add_cotizacion();BuscarMoldesRegistradosCliente(this.value, 'molde_select_cliente');BuscarFormaPagoCliente(this.value, 'sub_forma_pago');BuscarBuscarVendedorCliente(this.value, 'sub_vendedor');" class="chosen-select" style="width: 500px;">
                ...
                if (sizeof($datos_cotizacion) > 0) {
                    foreach ($clientes as $cliente) {
                        ...
                        if ($datos_cotizacion->id_cliente == $cliente->id) {
                            echo 'selected="true"';
                        }
                        ?>><?php echo $cliente->razon_social ?> <?php
                                    if ($cliente->estado == 2) {
                                        echo '(BLOQUEADO)';
                                    } if ($cliente->id_region == 0) {
                                        echo '( Info. Incompleta)';
                                    }
                                    ?></option>
                        <?php
                    }
                    ...
                    foreach ($clientes as $cliente) {
                        ?>
                        <option value="<?php echo $cliente->id ?>" <?php
                                    if (isset($_POST["cliente"]) and $_POST["cliente"] == $cliente->id) {
                                        echo 'selected="true"';
                                    }
                                    ?>><?php echo $cliente->razon_social ?> <?php
                        if ($cliente->estado == 2) {
                ...
                <select name="vendedor">
                            ...
                            if (sizeof($datos_cotizacion) > 0) {
                                foreach ($vendedores as $vendedor) {
                                    ?>
                            <option value="<?php echo $vendedor->id ?>" <?php
                    if ($vendedor->id == $datos_cotizacion->id_vendedor) {
                ...
                <option value="0">Seleccione.....</option>
                        ...
                        if (sizeof($datos_cotizacion) > 0) {
                            switch ($datos_cotizacion->condicion_del_producto) {
                                case 'Nuevo': $condicion = 0;
                                    break;
                                case 'Repetición Sin Cambios': $condicion = 1;
                                    break;
                                case 'Repetición Con Cambios': $condicion = 2;
                                    break;
                                case 'Producto Genérico': $condicion = 3;
                                    break;
                            }
                            ?>
                    <option value="0" <?php
                            ...
                            ?> style="font-weight:bold">Nuevo</option>
                    <option value="1" <?php
                            if ($condicion == 1) {
                                echo 'selected="true"';
                            }
                            ?>>Buscar Repetición?</option>
             <!--   <option value="2" <?php //if($datos_cotizacion->condicion_del_producto==$condicion){echo 'selected="true"';}  ?>>Repetición Con Cambios</option> -->
                    <option value="3" <?php
                            if ($condicion == 3) {
                                echo 'selected="true"';
                            }
                            ?>>Producto Genérico</option>                        
<?php } else { ?>
                    <option value="0" <?php
    if (isset($_POST["condicion_del_producto"]) and $_POST["condicion_del_producto"] == "0") {
        echo 'selected="true"';
    }
    ?> style="font-weight:bold">Nuevo</option>
                    <option value="1"<?php
    if (isset($_POST["condicion_del_producto"]) and $_POST["condicion_del_producto"] == "1") {
        echo 'selected="true"';
    }
    ?>>Buscar Repetición?</option>
             <!--   <option value="2"<?php //if(isset($_POST["condicion_del_producto"]) and $_POST["condicion_del_producto"]=="2"){echo 'selected="true"';}  ?>>Repetición Con Cambios</option> -->
                    <option value="3"<?php
    if (isset($_POST["condicion_del_producto"]) and $_POST["condicion_del_producto"] == "3") {
        echo 'selected="true"';
    }
    ?>>Producto Genérico</option>                          
            <?php } ?>
...
<?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="SI" <?php
                    if ($datos_cotizacion->acepta_excedentes == "SI") {
                        echo 'selected="true"';
                    }
                    ?>>SI</option>
                    <option value="NO" <?php
                    if ($datos_cotizacion->acepta_excedentes == "NO") {
                        echo 'selected="true"';
                    }
                    ?>>NO</option>
                <?php } else { ?>                    
                    <option value="SI" <?php
                if (isset($_POST["acepta_excedentes"]) and $_POST["acepta_excedentes"] == 'SI') {
                    echo 'selected="selected"';
                }
                    ?>>SI</option>
                    <option value="NO" <?php
                        if (isset($_POST["acepta_excedentes"]) and $_POST["acepta_excedentes"] == 'NO') {
                            echo 'selected="selected"';
                        }
                        ?>>NO</option>
<?php } ?>                       
...
<?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="SI" <?php
    if ($datos_cotizacion->vb_maquina == "SI") {
        echo 'selected="true"';
    }
    ?>>SI</option>
                    <option value="NO" <?php
                    if ($datos_cotizacion->vb_maquina == "NO") {
                        echo 'selected="true"';
                    }
                    ?>>NO</option>
                <?php } else { ?>          
                    <option value="SI" <?php
                            if (isset($_POST["vb_maquina"]) and $_POST["vb_maquina"] == 'SI') {
                                echo 'selected="selected"';
                            }
                            ?>>SI</option>
                    <option value="NO" <?php
                            if (isset($_POST["vb_maquina"]) and $_POST["vb_maquina"] == 'NO') {
                                echo 'selected="selected"';
                            }
                            ?>>NO</option>                            
                        <?php } ?>                       
...
<?php } else { ?>                    
                <textarea id="contenido4s" name="obs" placeholder="Observaciones"><?php
                    if (isset($_POST["obs"])) {
                        echo $_POST["obs"];
                    }
                    ?></textarea>
                ...
                <option value="0">No lleva.....</option>
                        ...
                        if (sizeof($datos_cotizacion) > 0) {
                            foreach ($piezas as $pieza) {
                                ?>
                        <option value="<?php echo $pieza->piezas_adicionales ?>" <?php
                                if ($pieza->piezas_adicionales == $datos_cotizacion->piezas_adicionales) {
                                    echo 'selected="selected"';
                                }
                                ?>><?php echo $pieza->piezas_adicionales ?></option>
        <?php
    }
} else {
    foreach ($piezas as $pieza) {
        ?>
                        <option value="<?php echo $pieza->piezas_adicionales ?>" <?php
                        if ($pieza->piezas_adicionales == $_POST["piezas_adicionales"]) {
                            echo 'selected="selected"';
                        }
                        ?>><?php echo $pieza->piezas_adicionales ?></option>
                                <?php
...
if (sizeof($datos_cotizacion) > 0) {
    foreach ($piezas as $pieza) {
        ?>
                        <option value="<?php echo $pieza->piezas_adicionales ?>" <?php
        if ($pieza->piezas_adicionales == $datos_cotizacion->piezas_adicionales2) {
            echo 'selected="selected"';
        }
        ?>><?php echo $pieza->piezas_adicionales ?></option>
                        <?php
                    ...
                    foreach ($piezas as $pieza) {
                        ?>
                        <option value="<?php echo $pieza->piezas_adicionales ?>" <?php
                        if ($pieza->piezas_adicionales == $_POST["piezas_adicionales2"]) {
                            echo 'selected="selected"';
                        }
                        ?>><?php echo $pieza->piezas_adicionales ?></option>
        <?php
            ...
            <select name="piezas_adicionales3" class="chosen-select">
                ...
                if (sizeof($datos_cotizacion) > 0) {
                    foreach ($piezas as $pieza) {
                        ?>
                        <option value="<?php echo $pieza->piezas_adicionales ?>" <?php
                                if ($pieza->piezas_adicionales == $datos_cotizacion->piezas_adicionales3) {
                                    echo 'selected="selected"';
                                }
                                ?>><?php echo $pieza->piezas_adicionales ?></option>
                        <?php
                    ...
                    foreach ($piezas as $pieza) {
                        ?>
                        <option value="<?php echo $pieza->piezas_adicionales ?>" <?php
                        if ($pieza->piezas_adicionales == $_POST["piezas_adicionales3"]) {
                            echo 'selected="selected"';
                        }
                        ?>><?php echo $pieza->piezas_adicionales ?></option>
        <?php
...
?>                  
    ...
    <div class="control-group">
        ...
        <div class="controls">
                ...
                <?php } else { ?>  
                <textarea id="contenido5" name="comentario_piezas_adicionales" placeholder="Observaciones"><?php
                            if (isset($_POST["comentario_piezas_adicionales"])) {
                                echo $_POST["comentario_piezas_adicionales"];
                            }
                            ?></textarea>
                <?php } ?>  
        </div>
    ...
    <div class="control-group" id="div_hay_que_troquelar">
        ...
        <div class="controls">
            <select name="hay_que_troquelar" style="width: 100px;" onchange="">
                        <?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="SI" <?php
                    if ($datos_cotizacion->hay_que_troquelar == 'SI') {
                        echo 'selected="true"';
                    }
                    ?>>SI</option> 
                    <option value="NO" <?php
                    if ($datos_cotizacion->hay_que_troquelar == "NO") {
                        echo 'selected="true"';
                    }
                    ?>>NO</option>
                    <option value="NO SE" <?php
                            if ($datos_cotizacion->hay_que_troquelar == "NO SE") {
                                echo 'selected="true"';
                            }
                            ?>>NO SE</option>
                        <?php } else { ?>
                    <option value="SI" <?php
                        if (isset($_POST["hay_que_troquelar"]) == 'SI') {
                            echo 'selected="selected"';
                        }
                        ?>>SI</option> 
                    <option value="NO" <?php
        if (isset($_POST["hay_que_troquelar"]) == 'NO') {
            echo 'selected="selected"';
        }
        ?>>NO</option>
                    <option value="NO SE" <?php
        if (isset($_POST["hay_que_troquelar"]) == 'NO SE') {
            echo 'selected="selected"';
        }
        ?>>NO SE</option>
    <?php } ?>   
    ...
    <?php if (sizeof($datos_cotizacion) > 0) { ?>                      
                    <option value="">Seleccione.....</option>
                    <option value="SI" <?php
        if ($datos_cotizacion->estan_los_moldes == "SI") {
            echo 'selected="selected"';
        }
        ?>>SI</option>
                    <option value="NO" <?php
        if ($datos_cotizacion->estan_los_moldes == "NO") {
            echo 'selected="selected"';
        }
        ?>>NO</option>
                    <option value="NO SE" <?php
    if ($datos_cotizacion->estan_los_moldes == "NO SE") {
        echo 'selected="selected"';
    }
    ?>>NO SE</option>
                    <option value="NO HAY QUE TROQUELAR"<?php
    if ($datos_cotizacion->estan_los_moldes == "NO HAY QUE TROQUELAR") {
        echo 'selected="selected"';
    }
        ?>>NO HAY QUE TROQUELAR</option>
                    <option value="CLIENTE LO APORTA" <?php
                            if ($datos_cotizacion->estan_los_moldes == "CLIENTE LO APORTA") {
                                echo 'selected="selected"';
                            }
                            ?>>CLIENTE LO APORTA</option>
                    <option value="MOLDE GENERICO" <?php
                            if ($datos_cotizacion->estan_los_moldes == "MOLDE GENERICO") {
                                echo 'selected="selected"';
                            }
                            ?>>MOLDE GENERICO</option>
                    <option value="MOLDE REGISTRADOS DEL CLIENTE" <?php
                        if ($datos_cotizacion->estan_los_moldes == "MOLDE REGISTRADOS DEL CLIENTE") {
                            echo 'selected="selected"';
                        }
                        ?>>MOLDE REGISTRADOS DEL CLIENTE</option>
                    <?php } else { ?>  
                    <option value="">Seleccione.....</option>
                    <option value="SI" <?php
                        if (isset($_POST["select_estan_los_moldes"]) and $_POST["select_estan_los_moldes"] == 'SI') {
                            echo 'selected="selected"';
                        }
                        ?>>SI</option>
                    <option value="NO" <?php
                    if (isset($_POST["select_estan_los_moldes"]) and $_POST["select_estan_los_moldes"] == 'NO') {
                        echo 'selected="selected"';
                    }
                        ?>>NO</option>
                    <option value="NO SE" <?php
                                if (isset($_POST["select_estan_los_moldes"]) and $_POST["select_estan_los_moldes"] == 'NO SE') {
                                    echo 'selected="selected"';
                                }
                                ?>>NO SE</option>
                    <option value="NO HAY QUE TROQUELAR" <?php
                                if (isset($_POST["select_estan_los_moldes"]) and $_POST["select_estan_los_moldes"] == 'NO HAY QUE TROQUELAR') {
                                    echo 'selected="selected"';
                                }
                                ?>>NO HAY QUE TROQUELAR</option>
                    <option value="CLIENTE LO APORTA" <?php
                                if (isset($_POST["select_estan_los_moldes"]) and $_POST["select_estan_los_moldes"] == 'CLIENTE LO APORTA') {
                                    echo 'selected="selected"';
                                }
                                ?>>CLIENTE LO APORTA</option>
                    <option value="MOLDE GENERICO" <?php
                    if (isset($_POST["select_estan_los_moldes"]) and $_POST["select_estan_los_moldes"] == 'MOLDE GENERICO') {
                        echo 'selected="selected"';
                    }
                    ?>>MOLDE GENERICO</option>
                    <option value="MOLDE REGISTRADOS DEL CLIENTE" <?php
                    if (isset($_POST["select_estan_los_moldes"]) and $_POST["select_estan_los_moldes"] == 'MOLDE REGISTRADOS DEL CLIENTE') {
                        echo 'selected="selected"';
                    }
                    ?>>MOLDE REGISTRADOS DEL CLIENTE</option>
                <?php } ?>                                 
...
<?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="SI" <?php
    if (($datos_cotizacion->estan_los_moldes == 'SI') or ( $datos_cotizacion->estan_los_moldes == 'MOLDE GENERICO')) {
        echo 'selected="true"';
    }
    ?>>SI</option> 
                    <option value="NO" <?php
    ...
    ?>>NO</option>
                <?php } else { ?>
                    <option value="SI" <?php
                    if (isset($_POST["select_estan_los_moldes_genericos"]) and $_POST["select_estan_los_moldes_genericos"] == 'SI') {
                        echo 'selected="selected"';
                    }
                    ?>>SI</option> 
                    <option value="NO" <?php
                    if (isset($_POST["select_estan_los_moldes_genericos"]) and $_POST["select_estan_los_moldes_genericos"] == 'NO') {
                        echo 'selected="selected"';
                    }
                    ?>>NO</option>
                <?php } ?>                  
            ...
            <div id="molde_select">
                <select name="molde_generico" id="molde_generico" style="width: 600px;" onchange="carga_ajax5('<?php echo base_url(); ?>moldes/detalle_ajax', this.value, 'div_moldes')";>
                    <option value="0">Seleccione.....</option>
                <?php
                ...
                foreach ($moldes as $molde) {
                    if (sizeof($datos_cotizacion) > 0) {
                        ?>
                            <option value="<?php echo $molde->id ?>" <?php
                        if ($datos_cotizacion->numero_molde == $molde->id) {
                            echo 'selected="selected"';
                        }
                        ?>><?php echo $molde->nombre ?> (N° <?php echo $molde->numero ?>)</option>
                    <?php } else { ?>
                            <option value="<?php echo $molde->id ?>" <?php
                        if ($_POST["molde_generico"] == $molde->id) {
                            echo 'selected="selected"';
                        }
                        ?>><?php echo $molde->nombre ?> (N° <?php echo $molde->numero ?>)</option>
                        <?php
    ...
    <div class="control-group" id="div_estan_los_moldes_clientes" <?php echo $ver_molde_cliente; ?>>
        ...
        <div class="controls">
            ...
            <select name="select_estan_los_moldes_no_genericos_clientes" style="width: 600px;" onchange="estanLosMoldes(this.value);">
                <option value="">Seleccione.....</option>
                <?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="SI" <?php
                            if (($datos_cotizacion->estan_los_moldes == 'SI') or ( $datos_cotizacion->estan_los_moldes == 'MOLDE REGISTRADOS DEL CLIENTE')) {
                                echo 'selected="true"';
                            }
                            ?>>SI</option> 
                    <option value="NO" <?php
...
<?php } else { ?>
                    <option value="SI" <?php
    if (isset($_POST["select_estan_los_moldes_no_genericos_clientes"]) and $_POST["select_estan_los_moldes_no_genericos_clientes"] == 'SI') {
        echo 'selected="selected"';
    }
    ?>>SI</option> 
                    <option value="NO" <?php
    if (isset($_POST["select_estan_los_moldes_no_genericos_clientes"]) and $_POST["select_estan_los_moldes_no_genericos_clientes"] == 'NO') {
        echo 'selected="selected"';
    }
    ?>>NO</option>
                    <?php } ?>   
            ...
            <div id="molde_select_cliente">
                ...
                <?php } else { ?>
                                <option value="<?php echo $molde->id ?>" <?php
                    if ($_POST["molde_registrado"] == $molde->id) {
                        echo 'selected="selected"';
                    }
                    ?>><?php echo $molde->nombre ?> (N° <?php echo $molde->numero ?>)</option>
                    <?php
                    ...
                    <?php
                            ...
                            if (sizeof($datos_cotizacion) > 0) {
                                switch ($datos_cotizacion->materialidad_datos_tecnicos) {
                                    case 'Microcorrugado': $datos_tecnicos = 1;
                                        break;
                                    case 'Corrugado': $datos_tecnicos = 2;
                                        break;
                                    case 'Cartulina-cartulina': $datos_tecnicos = 3;
                                        break;
                                    case 'Sólo Cartulina': $datos_tecnicos = 4;
                                        break;
                                    case 'Onda a la Vista (MicroCorrugado/Corrugado)': $datos_tecnicos = 5;
                                        break;
                                    case 'otro': $datos_tecnicos = 6;
                                        break;
                                    case 'Se solicita proposición': $datos_tecnicos = 7;
                                        break;
                                    case 'Onda a la Vista (Corrugado/Corrugado)': $datos_tecnicos = 9;
                                        break;
                                    case 'Onda a la Vista (MicroCorrugado/MicroCorrugado)': $datos_tecnicos = 10;
                                        break;
                                }
                            } else {
                            ...
                            foreach ($datosTecnicos as $datosTecnico) {
                                if (sizeof($datos_cotizacion) > 0) {
                                    ?>                
                        <option value="<?php echo $datosTecnico->id ?>" <?php
                                    if ($datos_tecnicos == $datosTecnico->id) {
                                        echo 'selected="true"';
                                    }
                                    ?>><?php echo $datosTecnico->datos_tecnicos ?></option>
    <?php } else { ?>
                        <option value="<?php echo $datosTecnico->id ?>" <?php
        if (isset($_POST["datos_tecnicos"]) and $_POST["datos_tecnicos"] == $datosTecnico->id) {
            echo 'selected="true"';
        }
        ?>><?php echo $datosTecnico->datos_tecnicos ?></option>
                        <?php
...
foreach ($tapas as $tapa) {
    if (sizeof($datos_cotizacion) > 0) {
        ?>                
                            <option value="<?php echo $tapa->nombre ?>" <?php
        if ($datos_cotizacion->materialidad_1 == $tapa->nombre) {
            echo 'selected="true"';
        }
        ?>><?php echo $tapa->gramaje ?> ( <?php echo $tapa->materiales_tipo ?> - $<?php echo $tapa->precio ?> ) (<?php echo $tapa->reverso ?>)</option>
                    <?php } else { ?>
                            <option value="<?php echo $tapa->nombre ?>"<?php
                        if ($tapa->nombre == $_POST["materialidad_1"]) {
                            echo 'selected="true"';
                        }
                        ?>><?php echo $tapa->gramaje ?> ( <?php echo $tapa->materiales_tipo ?> - $<?php echo $tapa->precio ?> ) (<?php echo $tapa->reverso ?>)</option>
        <?php
            ...
            <div class="controls">
                ...
                foreach ($tapas as $tapa) {
                    if (sizeof($datos_cotizacion) > 0) {
                        ?>                
                            <option value="<?php echo $tapa->nombre ?>" <?php
                        if ($datos_cotizacion->materialidad_2 == $tapa->nombre) {
                            echo 'selected="true"';
                        }
                        ?>><?php echo $tapa->gramaje ?> ( <?php echo $tapa->materiales_tipo ?> - $<?php echo $tapa->precio ?> ) (<?php echo $tapa->reverso ?>)</option>
                    <?php } else { ?>
                            <option value="<?php echo $tapa->nombre ?>"<?php
                                if ($tapa->nombre == $_POST["materialidad_2"]) {
                                    echo 'selected="true"';
                                }
                                ?>><?php echo $tapa->gramaje ?> ( <?php echo $tapa->materiales_tipo ?> - $<?php echo $tapa->precio ?> ) (<?php echo $tapa->reverso ?>)</option>
        <?php
...
foreach ($tapas as $tapa) {
    if (sizeof($datos_cotizacion) > 0) {
        ?>                
                            <option value="<?php echo $tapa->nombre ?>" <?php
                 if (strtoupper(trim($datos_cotizacion->materialidad_3)) == strtoupper(trim($tapa->nombre))) {
                     echo 'selected="true"';
                 }
                 ?>><?php echo $tapa->gramaje ?> ( <?php echo $tapa->materiales_tipo ?> - $<?php echo $tapa->precio ?> ) (<?php echo $tapa->reverso ?>)</option>
                    <?php } else { ?>
                            <option value="<?php echo $tapa->nombre ?>"<?php
                if ($tapa->nombre == $_POST["materialidad_3"]) {
                    echo 'selected="true"';
                }
                        ?>><?php echo $tapa->gramaje ?> ( <?php echo $tapa->materiales_tipo ?> - $<?php echo $tapa->precio ?> ) (<?php echo $tapa->reverso ?>)</option>
                        <?php
...
<?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="SI" <?php
    if ($datos_cotizacion->materialidad_solicita_muestra == "SI") {
        echo 'selected="true"';
    }
    ?>>SI</option>
                    <option value="NO" <?php
    if ($datos_cotizacion->materialidad_solicita_muestra == "NO") {
        echo 'selected="true"';
    }
    ?>>NO</option>
<?php } else { ?>                    
                    <option value="SI" <?php
    if (isset($_POST["solicita_muestra"]) and $_POST["solicita_muestra"] == 'SI') {
        echo 'selected="selected"';
    }
    ?>>SI</option> 
                    <option value="NO" <?php
                    if (isset($_POST["solicita_muestra"]) and $_POST["solicita_muestra"] == 'NO') {
                        echo 'selected="selected"';
                    }
                    ?>>NO</option>
                        <?php } ?>                   
            ...
            <select name="colores" onchange="cromalin(this.value);verificar_color();" >
                <option value="">Seleccione.....</option>
                        ...
                        <option value="<?php echo $i ?>" <?php
                                if ($datos_cotizacion->impresion_colores == $i) {
                                    echo 'selected="true"';
                                }
                                ?>><?php echo $i ?></option>
    <?php } else { ?>
                        <option value="<?php echo $i ?>" <?php
        if (isset($_POST["colores"]) and $_POST["colores"] == $i) {
            echo 'selected="true"';
        }
        ?>><?php echo $i ?></option>
                        <?php
...
for ($i = 0; $i < 3; $i++) {
    if (sizeof($datos_cotizacion) > 0) {
        ?>                
                        <option value="<?php echo $i ?>" <?php
            if ($datos_cotizacion->impresion_metalicos == $i) {
                echo 'selected="true"';
            }
            ?>><?php echo $i ?></option>
    <?php } else { ?>
                        <option value="<?php echo $i ?>" <?php
                        if (isset($_POST["colores_metalicos"]) and $_POST["colores_metalicos"] == $i) {
                            echo 'selected="true"';
                        }
                        ?>><?php echo $i ?></option>
                        <?php
...
<?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="SI" <?php
    if ($datos_cotizacion->tiene_fondo == "SI") {
        echo 'selected="true"';
    }
    ?>>SI</option>
                    <option value="NO" <?php
    if (($datos_cotizacion->tiene_fondo == "NO") or ( $datos_cotizacion->tiene_fondo == "")) {
        echo 'selected="true"';
    }
    ?>>NO</option>
                <?php } else { ?>                    
                    <option value="NO" <?php
                    if (isset($_POST["tiene_fondo"]) == "NO") {
                        echo 'selected="selected"';
                    }
                    ?>>NO</option>
                    <option value="SI" <?php
                            if (isset($_POST["tiene_fondo"]) == "SI") {
                                echo 'selected="selected"';
                            }
                            ?>>SI</option>
                        <?php } ?>                       
    ...
    <div class="control-group"  <?php
        ...
        <div class="controls">
            <select id="proceso_fondo" name="proceso_fondo" style="width: 100px;">
                ...
                <?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="CO" <?php
                            if ($datos_cotizacion->proceso_fondo == "CO") {
                                echo 'selected="true"';
                            }
                            ?>>Al Corte</option>
                    <option value="CE" <?php
                        if ($datos_cotizacion->proceso_fondo == "CE") {
                            echo 'selected="true"';
                        }
                        ?>>Al Centro</option>
                    <option value="NO" <?php
                        if ($datos_cotizacion->proceso_fondo == "NO") {
                            echo 'selected="true"';
                        }
                        ?>>No se Sabe</option>                                
                <?php } else { ?>                    
                    <option value="CO" <?php
                    if (isset($_POST["proceso_fondo"]) == "CO") {
                        echo 'selected="selected"';
                    }
                    ?>>Al Corte</option>
                    <option value="CE" <?php
                            if (isset($_POST["proceso_fondo"]) == "CE") {
                                echo 'selected="selected"';
                            }
                            ?>>Al Centro</option>
                    <option value="NO" <?php
                        if (isset($_POST["proceso_fondo"]) == "NO") {
                            echo 'selected="selected"';
                        }
                        ?>>No se Sabe</option>
<?php } ?>                           
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select name="lleva_barniz" style="width: 200px;">
                <option value="">Seleccione.....</option>
                        <?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="Barniz Acuoso" <?php
                            if ($datos_cotizacion->lleva_barniz == "Barniz Acuoso") {
                                echo 'selected="true"';
                            }
                            ?>>Barniz Acuoso</option>
                    <option value="Barniz Sobre Impresion" <?php
                            if ($datos_cotizacion->lleva_barniz == "Barniz Sobre Impresion") {
                                echo 'selected="true"';
                            }
                            ?>>Barniz Sobre ImpresiÃ³n</option>                    
                    <option value="Laca UV" <?php
                            if ($datos_cotizacion->lleva_barniz == "Laca UV") {
                                echo 'selected="true"';
                            }
                            ?>>Laca UV</option>                    
                    <option value="No Se" <?php
                            if ($datos_cotizacion->lleva_barniz == "No Se") {
                                echo 'selected="true"';
                            }
                            ?>>No Se</option>                    
                    <option value="Nada" <?php
                            if ($datos_cotizacion->lleva_barniz == "Nada") {
                                echo 'selected="true"';
                            }
                            ?>>Nada</option>                    
<?php } else { ?>                    
                    <option value="Barniz Acuoso" <?php
    if (isset($_POST["lleva_barniz"]) == "Barniz Acuoso") {
        echo 'selected="selected"';
    }
    ?>>Barniz Acuoso</option>
                    <option value="Barniz Sobre Impresion" <?php
    if (isset($_POST["lleva_barniz"]) == "Barniz Sobre Impresion") {
        echo 'selected="selected"';
    }
    ?>>Barniz Sobre ImpresiÃ³n</option>
                    <option value="Laca UV" <?php
    if (isset($_POST["lleva_barniz"]) == "Laca UV") {
        echo 'selected="selected"';
    }
    ?>>Laca UV</option>
                    <option value="No Se" <?php
                    if (isset($_POST["lleva_barniz"]) == "No Se") {
                        echo 'selected="selected"';
                    }
                    ?>>No SE</option>
                    <option value="Nada" <?php
                            if (isset($_POST["lleva_barniz"]) == "Nada") {
                                echo 'selected="selected"';
                            }
                            ?>>Nada</option>
<?php } ?>                        
    ...
    <div class="control-group" id="reserva_barniz" <?php
if ($datos_cotizacion->reserva_barniz == "") {
    echo "hidden=true";
}
?>>
        ...
        <div class="controls">
            <select name="reserva_barniz" style="width: 200px;">
                <option value="">Seleccione.....</option>
                        <?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="Con Reserva" <?php
                    if ($datos_cotizacion->reserva_barniz == "Con Reserva") {
                        echo 'selected="true"';
                    }
                    ?>>Con Reserva</option>
                    <option value="Sin Reserva" <?php
                            if ($datos_cotizacion->reserva_barniz == "Sin Reserva") {
                                echo 'selected="true"';
                            }
                            ?>>Sin Reserva</option>                    
<?php } else { ?>                    
                    <option value="Con Reserva" <?php
    if (isset($_POST["reserva_barniz"]) == "Con Reserva") {
        echo 'selected="selected"';
    }
    ?>>Con Reserva</option>
                    <option value="Sin Reserva" <?php
    if (isset($_POST["reserva_barniz"]) == "Sin Reserva") {
        echo 'selected="selected"';
    }
    ?>>Sin Reserva</option>
                <?php } ?>                        
    ...
    <div class="control-group"  id="cala_caucho" <?php
                        if ($datos_cotizacion->cala_caucho == "") {
                            echo "hidden=true";
                        }
                        ?>>
        ...
        <div class="controls">
            <select name="cala_caucho" style="width: 200px;">
                ...
                <?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="Si" <?php
                            if ($datos_cotizacion->cala_caucho == "Si") {
                                echo 'selected="true"';
                            }
                            ?>>Si</option>
                    <option value="No" <?php
                        if ($datos_cotizacion->cala_caucho == "No") {
                            echo 'selected="true"';
                        }
                            ?>>No</option>                    
                  <?php } else { ?>                    
                    <option value="Si" <?php
                        if (isset($_POST["cala_caucho"]) == "Si") {
                            echo 'selected="selected"';
                        }
                        ?>>Si</option>
                    <option value="No" <?php
                                if (isset($_POST["cala_caucho"]) == "No") {
                                    echo 'selected="selected"';
                                }
                                ?>>No</option>
                            <?php } ?>                        
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select style="width: 600px;" name="acabado_impresion_1">
                <option value="">Seleccione.....</option>
<?php foreach ($internos as $interno) { ?>
    <?php if (sizeof($datos_cotizacion) > 0) { ?>
                        <option value="<?php echo $interno->id ?>" <?php
        if ($datos_cotizacion->impresion_acabado_impresion_1 == $interno->id) {
            echo 'selected="true"';
        }
        ?>><?php echo $interno->caracteristicas ?></option>
                    <?php } else { ?>                    
                        <option value="<?php echo $interno->id ?>" <?php
                        if ($interno->id == $_POST["acabado_impresion_1"]) {
                            echo 'selected="selected"';
                        }
                        ?>><?php echo $interno->caracteristicas ?></option>
                    <?php } ?>                    
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select style="width: 600px;" name="acabado_impresion_2" onchange="procesosInternos();">
                <option value="">Seleccione.....</option>
                        <?php foreach ($internos as $interno) { ?>
                            <?php if (sizeof($datos_cotizacion) > 0) { ?>
                        <option value="<?php echo $interno->id ?>" <?php
                                if ($datos_cotizacion->impresion_acabado_impresion_2 == $interno->id) {
                                    echo 'selected="true"';
                                }
                                ?>><?php echo $interno->caracteristicas ?></option>
                <?php } else { ?>                    
                        <option value="<?php echo $interno->id ?>" <?php
                          if ($interno->id == $_POST["acabado_impresion_2"]) {
                              echo 'selected="selected"';
                          }
                          ?>><?php echo $interno->caracteristicas ?></option>
                        <?php } ?>                    
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select style="width: 600px;" name="acabado_impresion_3" onchange="procesosInternos();">
                <option value="">Seleccione.....</option>
                    <?php foreach ($internos as $interno) { ?>
                        <?php if (sizeof($datos_cotizacion) > 0) { ?>
                        <option value="<?php echo $interno->id ?>" <?php
                                    if ($datos_cotizacion->impresion_acabado_impresion_3 == $interno->id) {
                                        echo 'selected="true"';
                                    }
                                    ?>><?php echo $interno->caracteristicas ?></option>
    <?php } else { ?>                    
                        <option value="<?php echo $interno->id ?>" <?php
        if ($interno->id == $_POST["acabado_impresion_3"]) {
            echo 'selected="selected"';
        }
        ?>><?php echo $interno->caracteristicas ?></option>
    <?php } ?>                    
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select style="width: 600px;" name="acabado_impresion_4">
                <option value="">Seleccione.....</option>
                <?php foreach ($externos as $externo) { ?>
                    <?php if (sizeof($datos_cotizacion) > 0) { ?>
                        <option value="<?php echo $externo->id ?>" <?php
                        if ($datos_cotizacion->impresion_acabado_impresion_4 == $externo->id) {
                            echo 'selected="true"';
                        }
                        ?>><?php echo $externo->caracteristicas ?></option>
                            <?php } else { ?>                    
                        <option value="<?php echo $externo->id ?>" <?php
                        if ($externo->id == $_POST["acabado_impresion_4"]) {
                            echo 'selected="selected"';
                        }
                                ?>><?php echo $externo->caracteristicas ?></option>
                <?php } ?>                    
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select style="width: 600px;" name="acabado_impresion_5" onchange="procesosExternos();">
                <option value="">Seleccione.....</option>                    
                            <?php foreach ($externos as $externo) { ?>
                        <?php if (sizeof($datos_cotizacion) > 0) { ?>
                        <option value="<?php echo $externo->id ?>" <?php
                                    if ($datos_cotizacion->impresion_acabado_impresion_5 == $externo->id) {
                                        echo 'selected="true"';
                                    }
                                    ?>><?php echo $externo->caracteristicas ?></option>
                                <?php } else { ?>                    
                        <option value="<?php echo $externo->id ?>" <?php
                                    if ($externo->id == $_POST["acabado_impresion_5"]) {
                                        echo 'selected="selected"';
                                    }
                                    ?>><?php echo $externo->caracteristicas ?></option>
    <?php } ?>                    
...
?>  
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select style="width: 600px;" name="acabado_impresion_6" onchange="procesosExternos();">
                <option value="">Seleccione.....</option>                    
                <?php foreach ($externos as $externo) { ?>
                    <?php if (sizeof($datos_cotizacion) > 0) { ?>
                        <option value="<?php echo $externo->id ?>" <?php
                                if ($datos_cotizacion->impresion_acabado_impresion_6 == $externo->id) {
                                    echo 'selected="true"';
                                }
                                ?>><?php echo $externo->caracteristicas ?></option>
                    <?php } else { ?>                    
                        <option value="<?php echo $externo->id ?>" <?php
                                if ($externo->id == $_POST["acabado_impresion_6"]) {
                                    echo 'selected="selected"';
                                }
                                ?>><?php echo $externo->caracteristicas ?></option>
                            <?php } ?>                    
        ...
        <div class="controls">
            <select name="hacer_cromalin" style="width: 100px;" id="dir">
                <option value="">Seleccione.....</option>
                    <?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="NO" <?php
                                if ($datos_cotizacion->impresion_hacer_cromalin == "NO") {
                                    echo 'selected="true"';
                                }
                                ?>>NO</option>
                    <option value="SI" <?php
                                if ($datos_cotizacion->impresion_hacer_cromalin == "SI") {
                                    echo 'selected="true"';
                                }
                                ?>>SI</option>                    
                    <?php } else { ?>                    
                    <option value="NO" <?php
                    if (isset($_POST["hacer_cromalin"]) == "NO") {
                        echo 'selected="selected"';
                    }
                        ?>>NO</option>
                    <option value="SI" <?php
                                if (isset($_POST["hacer_cromalin"]) == "SI") {
                                    echo 'selected="selected"';
                                }
                                ?>>SI</option>
<?php } ?>                       
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select name="folia" style="width: 100px;" onchange="cambiaFolia_Cotizacion();">
                <?php
                        if (sizeof($datos_cotizacion) == 0) {
                            $procesos_especiales = $_POST["folia"];
                            ?>
                    <option value="NO" <?php
                            if (isset($_POST["folia"]) == "NO") {
                                echo 'selected="selected"';
                            }
                            ?>>NO</option>
                    <option value="SI" <?php
                    if (isset($_POST["folia"]) == "SI") {
                        echo 'selected="selected"';
                    }
                    ?>>SI</option>
                            <?php
                            ...
                            ?>
                    <option value="NO" <?php
                        if ($datos_cotizacion->procesos_especiales_folia == "NO") {
                            echo 'selected="true"';
                        }
                        ?>>NO</option>
                    <option value="SI" <?php
                if ($datos_cotizacion->procesos_especiales_folia == "SI") {
                    echo 'selected="true"';
                }
                ?>>SI</option>
                        <?php
            ...
            <span id="folia_se_a" style="display: <?php
                    if ($procesos_especiales == 'SI') {
                        echo 'block';
                    } else {
                        echo 'none';
                    }
                ...
                <select name="folia_se" id="folia_se">
                    <?php
                        ...
                        <option value="Nuevo" <?php
                                if (isset($_POST["folia_se"]) == "NO") {
                                    echo 'selected="selected"';
                                }
                                ?>>Nuevo</option>
                        <option value="Repetición" <?php
                            if (isset($_POST["folia_se"]) == "SI") {
                                echo 'selected="selected"';
                            }
                            ?>>Repetición</option>                        
    <?php
    ...
    ?>
                        <option value="Nuevo" <?php
    if ($datos_cotizacion->procesos_especiales_folia_valor == "Nuevo") {
        echo 'selected="true"';
    }
    ?>>Nuevo</option>
                        <option value="Repetición" <?php
                    if ($datos_cotizacion->procesos_especiales_folia_valor == "Repetición") {
                        echo 'selected="true"';
                    }
                    ?>>Repetición</option>
                            <?php
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select name="folia_2" style="width: 100px;" onchange="cambiaFolia2_Cotizacion();">
<?php
if (sizeof($datos_cotizacion) == 0) {
    $procesos_especiales2 = $_POST["folia_2"];
    ?>
                    <option value="NO" <?php
    if (isset($_POST["folia_2"]) == "NO") {
        echo 'selected="selected"';
    }
    ?>>NO</option>
                    <option value="SI" <?php
    if (isset($_POST["folia_2"]) == "SI") {
        echo 'selected="selected"';
    }
    ?>>SI</option>
                    <?php
                    ...
                    ?>
                    <option value="NO" <?php
                            if ($datos_cotizacion->procesos_especiales_folia_2 == "NO") {
                                echo 'selected="true"';
                            }
                            ?>>NO</option>
                    <option value="SI" <?php
                            if ($datos_cotizacion->procesos_especiales_folia_2 == "SI") {
                                echo 'selected="true"';
                            }
                            ?>>SI</option>
    <?php
...
?>
            ...
            <span id="folia_se_2_a" style="display: <?php
                if ($procesos_especiales2 == 'SI') {
                    echo 'block';
                } else {
                    echo 'none';
                }
                ...
                <?php
                        if (sizeof($datos_cotizacion) == 0) {
                            ?>
                        <option value="Nuevo" <?php
                            if (isset($_POST["folia_se_2"]) == "NO") {
                                echo 'selected="selected"';
                            }
                            ?>>Nuevo</option>
                        <option value="Repetición" <?php
                if (isset($_POST["folia_se_2"]) == "SI") {
                    echo 'selected="selected"';
                }
                ?>>Repetición</option>                                            
    <?php
    ...
    ?>
                        <option value="Nuevo" <?php
    if ($datos_cotizacion->procesos_especiales_folia_2_valor == "Nuevo") {
        echo 'selected="true"';
    }
    ?>>Nuevo</option>
                        <option value="Repetición" <?php
    if ($datos_cotizacion->procesos_especiales_folia_2_valor == "Repetición") {
        echo 'selected="true"';
    }
    ?>>Repetición</option>
    <?php
...
?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select name="folia_3" style="width: 100px;" onchange="cambiaFolia3_Cotizacion();">
                <?php
                if (sizeof($datos_cotizacion) == 0) {
                    $procesos_especiales3 = $_POST["folia_3"];
                    ?>
                    <option value="NO" <?php
                    if (isset($_POST["folia_3"]) == "NO") {
                        echo 'selected="selected"';
                    }
                    ?>>NO</option>
                    <option value="SI" <?php
                            if (isset($_POST["folia_3"]) == "SI") {
                                echo 'selected="selected"';
                            }
                            ?>>SI</option>
    <?php
    ...
    ?>
                    <option value="NO" <?php
                if ($datos_cotizacion->procesos_especiales_folia_3 == "NO") {
                    echo 'selected="true"';
                }
                ?>>NO</option>
                    <option value="SI" <?php
                if ($datos_cotizacion->procesos_especiales_folia_3 == "SI") {
                    echo 'selected="true"';
                }
                ?>>SI</option>
                                                                                                <?php
            ...
            <span id="folia_se_3_a" style="display: <?php
            if ($procesos_especiales3 == 'SI') {
                echo 'block';
            } else {
                echo 'none';
            }
                ...
                if (sizeof($datos) == 0) {
                    ?>
                        <option value="Nuevo" <?php
                    if (isset($_POST["folia_se_3_a"]) == "NO") {
                        echo 'selected="selected"';
                    }
                    ?>>Nuevo</option>
                        <option value="Repetición" <?php
                    if (isset($_POST["folia_se_3_a"]) == "SI") {
                        echo 'selected="selected"';
                    }
                    ?>>Repetición</option>                                            
                    <?php
                    ...
                    ?>
                        <option value="Nuevo" <?php
                    if ($datos_cotizacion->procesos_especiales_folia_3_valor == "Nuevo") {
                        echo 'selected="true"';
                    }
                    ?>>Nuevo</option>
                        <option value="Repetición" <?php
                    if ($datos_cotizacion->procesos_especiales_folia_3_valor == "Repetición") {
                        echo 'selected="true"';
                    }
                    ?>>Repetición</option>
    <?php
...
?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select name="cuno" style="width: 100px;" onchange="cambiaCuno_Cotizacion();">
                <?php
                if (sizeof($datos_cotizacion) == 0) {
                    $procesos_especiales4 = $_POST["cuno"];
                    ?>
                    <option value="NO" <?php
                if (isset($_POST["cuno"]) == "NO") {
                    echo 'selected="selected"';
                }
                    ?>>NO</option>
                    <option value="SI" <?php
                    if (isset($_POST["cuno"]) == "SI") {
                        echo 'selected="selected"';
                    }
                    ?>>SI</option>
                            <?php
                            ...
                            ?>
                    <option value="NO" <?php
                            if ($datos_cotizacion->procesos_especiales_cuno == "NO") {
                                echo 'selected="true"';
                            }
                            ?>>NO</option>
                    <option value="SI" <?php
                            if ($datos_cotizacion->procesos_especiales_cuno == "SI") {
                                echo 'selected="true"';
                            }
                            ?>>SI</option>
                    <?php
            ...
            <span id="cuno_se_a" style="display: <?php
                        if ($procesos_especiales4 == 'SI') {
                            echo 'block';
                        } else {
                            echo 'none';
                        }
...
if (sizeof($datos_cotizacion) == 0) {
    ?>
                        <option value="Nuevo" <?php
    if (isset($_POST["cuno_se"]) == "NO") {
        echo 'selected="selected"';
    }
    ?>>Nuevo</option>
                        <option value="Repetición" <?php
                    if (isset($_POST["cuno_se"]) == "SI") {
                        echo 'selected="selected"';
                    }
                    ?>>Repetición</option>                                            
                    <?php
                    ...
                    ?>
                        ...
                        <option value="Nuevo" <?php
                            if ($datos_cotizacion->procesos_especiales_cuno_valor == "Nuevo") {
                                echo 'selected="true"';
                            }
                            ?>>Nuevo</option>
                        <option value="Repetición" <?php
                    if ($datos_cotizacion->procesos_especiales_cuno_valor == "Repetición") {
                        echo 'selected="true"';
                    }
                    ?>>Repetición</option>
                            <?php
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select name="cuno_2" style="width: 100px;" onchange="cambiaCuno2_Cotizacion();">
                        <?php
                        if (sizeof($datos_cotizacion) == 0) {
                            $procesos_especiales5 = $_POST["cuno_2"];
                            ?>
                    <option value="NO" <?php
                    if (isset($_POST["cuno_2"]) == "NO") {
                        echo 'selected="selected"';
                    }
                    ?>>NO</option>
                    <option value="SI" <?php
                        if (isset($_POST["cuno_2"]) == "SI") {
                            echo 'selected="selected"';
                        }
                        ?>>SI</option>
    <?php
    ...
    ?>
                    <option value="NO" <?php
    if ($datos_cotizacion->procesos_especiales_cuno_2 == "NO") {
        echo 'selected="true"';
    }
    ?>>NO</option>
                    <option value="SI" <?php
    if ($datos_cotizacion->procesos_especiales_cuno_2 == "SI") {
        echo 'selected="true"';
    }
    ?>>SI</option>
    <?php
...
?>
            ...
            <span id="cuno_se_2_a" style="display: <?php
                    if ($procesos_especiales5 == 'SI') {
                        echo 'block';
                    } else {
                        echo 'none';
                    }
                ...
                <select name="cuno_se_2">
                            ...
                            if (sizeof($datos_cotizacion) == 0) {
                                ?>
                        <option value="Nuevo" <?php
                                if (isset($_POST["cuno_se_2"]) == "NO") {
                                    echo 'selected="selected"';
                                }
                                ?>>Nuevo</option>
                        <option value="Repetición" <?php
                            if (isset($_POST["cuno_se_2"]) == "SI") {
                                echo 'selected="selected"';
                            }
                            ?>>Repetición</option>                                            
    <?php
    ...
    ?>
                        <option value="Nuevo" <?php
    if ($datos_cotizacion->procesos_especiales_cuno_2_valor == "Nuevo") {
        echo 'selected="true"';
    }
    ?>>Nuevo</option>
                        <option value="Repetición" <?php
                            if ($datos_cotizacion->procesos_especiales_cuno_2_valor == "Repetición") {
                                echo 'selected="true"';
                            }
                            ?>>Repetición</option>
                            <?php
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="NO" <?php
                if ($datos_cotizacion->producto_se_entrega_armado == "NO") {
                    echo 'selected="true"';
                }
                ?>>NO</option>
                    <option value="SI" <?php
                if ($datos_cotizacion->producto_se_entrega_armado == "SI") {
                    echo 'selected="true"';
                }
                ?>>SI</option>                    
<?php } else { ?>                    
                    <option value="NO" <?php
    if (isset($_POST["producto_se_entrega_armado"]) == "NO") {
        echo 'selected="selected"';
    }
    ?>>NO</option>
                    <option value="SI" <?php
                if (isset($_POST["producto_se_entrega_armado"]) == "SI") {
                    echo 'selected="selected"';
                }
                ?>>SI</option>
            <?php } ?>                     
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="NO" <?php
                if ($datos_cotizacion->tiene_desgajado == "NO") {
                    echo 'selected="true"';
                }
                ?>>NO</option>
                    <option value="SI" <?php
            if ($datos_cotizacion->tiene_desgajado == "SI") {
                echo 'selected="true"';
            }
                ?>>SI</option>                    
            <?php } else { ?>                    
                    <option value="NO" <?php
            if (isset($_POST["tiene_desgajado"]) == "NO") {
                echo 'selected="selected"';
            }
                ?>>NO</option>
                    <option value="SI" <?php
                if (isset($_POST["tiene_desgajado"]) == "SI") {
                    echo 'selected="selected"';
                }
                ?>>SI</option>
            <?php } ?>                  
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="NO" <?php
                if ($datos_cotizacion->montaje_pieza_especial == "NO") {
                    echo 'selected="true"';
                }
                ?>>NO</option>
                    <option value="SI" <?php
                if ($datos_cotizacion->montaje_pieza_especial == "SI") {
                    echo 'selected="true"';
                }
                ?>>SI</option>                    
            <?php } else { ?>                    
                    <option value="NO" <?php
            if (isset($_POST["montaje_pieza_especial"]) == "NO") {
                echo 'selected="selected"';
            }
            ?>>NO</option>
                    <option value="SI" <?php
            if (isset($_POST["montaje_pieza_especial"]) == "SI") {
                echo 'selected="selected"';
            }
            ?>>SI</option>
<?php } ?>   
            ...
            <br />
            <div id="mostrar_texto_pieza_especial" style="display: <?php
if ($datos_cotizacion->comentarios_montaje_pieza_especial == '') {
    echo 'none';
} else {
    echo 'block';
}
        ...
        <div class="controls">
            <select name="cantidad_especifica_sino">
                <option value="">Seleccione.....</option>                
                   <?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="NO" <?php
                       if ($datos_cotizacion->cantidad_especifica_sino == "NO") {
                           echo 'selected="true"';
                       }
                       ?>>NO</option>
                    <option value="SI" <?php
            if ($datos_cotizacion->cantidad_especifica_sino == "SI") {
                echo 'selected="true"';
            }
            ?>>SI</option>                    
<?php } else { ?>                    
                    <option value="NO" <?php
    if (isset($_POST["cantidad_especifica_sino"]) == "NO") {
        echo 'selected="selected"';
    }
    ?>>NO</option>
                    <option value="SI" <?php
    if (isset($_POST["cantidad_especifica_sino"]) == "SI") {
        echo 'selected="selected"';
    }
    ?>>SI</option>
<?php } ?>   
...
<?php } ?>       
<?php if (sizeof($datos_cotizacion) > 0) { ?>
                <input <?php if ($datos_cotizacion->cantidad_especifica == 0) echo "checked" ?> onClick="if (this.checked == true) {
                                invalidarCantidadaEmpaquetar();
                            }" type="checkbox"  id="cantidad_a_empaquetar_a_criterio" name="cantidad_a_empaquetar_a_criterio" value="cantidad_a_empaquetar_a_criterio">Cantidad a Empaquetar a Criterio de Empresa
<?php } else { ?>                    
                <input <?php if ($_POST["cantidad_especifica"] == 0) echo "checked" ?> onClick="if (this.checked == true) {
                                invalidarCantidadaEmpaquetar();
                            }" type="checkbox"  id="cantidad_a_empaquetar_a_criterio" name="cantidad_a_empaquetar_a_criterio" value="cantidad_a_empaquetar_a_criterio">Cantidad a Empaquetar a Criterio de Empresa
<?php } ?>                       
        </div>
...
<?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="">Seleccione.....</option>                
                    <option value="Paletizado" <?php
    if ($datos_cotizacion->envasado == "Paletizado") {
        echo 'selected="true"';
    }
    ?>>Paletizado</option>
                    <option value="Paquetes" <?php
    if ($datos_cotizacion->envasado == "Paquetes") {
        echo 'selected="true"';
    }
    ?>>Paquetes</option>
                    <option value="Cartón Corrugado" <?php
    if ($datos_cotizacion->envasado == "Cartón Corrugado") {
        echo 'selected="true"';
    }
    ?>>Cartón Corrugado</option>                
<?php } else { ?>                    
                    <option value="" <?php
    ...
    ?>>Seleccione.....</option>                
                    <option value="Paletizado" <?php
    if (isset($_POST["envasado"]) == "Paletizado") {
        echo 'selected="selected"';
    }
    ?> >Paletizado</option>
                    <option value="Paquetes" <?php
    if (isset($_POST["envasado"]) == "Paquetes") {
        echo 'selected="selected"';
    }
    ?>>Paquetes</option>
                    <option value="Cartón Corrugado" <?php
    if (isset($_POST["envasado"]) == "Cartón Corrugado") {
        echo 'selected="selected"';
    }
    ?>>Cartón Corrugado</option>
<?php } ?>                   
...
<?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="NO" <?php
    if ($datos_cotizacion->despacho_fuera_de_santiago == "NO") {
        echo 'selected="true"';
    }
    ?>>NO</option>
                    <option value="SI" <?php
    if ($datos_cotizacion->despacho_fuera_de_santiago == "SI") {
        echo 'selected="true"';
    }
    ?>>SI</option>                    
<?php } else { ?>                    
                    <option value="NO" <?php
    if (isset($_POST["despacho_fuera_de_santiago"]) == "NO") {
        echo 'selected="selected"';
    }
    ?>>NO</option>
                    <option value="SI" <?php
    if (isset($_POST["despacho_fuera_de_santiago"]) == "SI") {
        echo 'selected="selected"';
    }
    ?>>SI</option>
<?php } ?>   
...
<?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="NO" <?php
    if ($datos_cotizacion->retira_cliente == "NO") {
        echo 'selected="true"';
    }
    ?>>SI, Retira Cliente</option>
                    <option value="SI" <?php
    if ($datos_cotizacion->retira_cliente == "SI") {
        echo 'selected="true"';
    }
    ?>>Despacho Empresa</option>                    
<?php } else { ?>                    
                    <option value="SI" <?php
    if ($_POST["retira_cliente"] == "SI") {
        echo 'selected="true"';
    }
    ?>>SI, Retira Cliente</option>
                    <option value="NO" <?php
    if ($_POST["retira_cliente"] == "NO") {
        echo 'selected="true"';
    }
    ?>>Despacho Empresa</option>
<?php } ?>                  
...
<?php if (sizeof($datos_cotizacion) > 0) { ?>
    ...
    if ($datos_cotizacion->tota_o_parcial == "Total") {
        echo 'selected="true"';
    }
    ?>>Total</option>
                    <option value="Parcial" <?php
    if ($datos_cotizacion->tota_o_parcial == "Parcial") {
        echo 'selected="true"';
    }
    ?>>Parcial</option>
                    <option value="despachos semanales" <?php
    if ($datos_cotizacion->tota_o_parcial == "despachos semanales") {
        echo 'selected="true"';
    }
    ?>>despachos semanales</option>
                    <option value="despachos mensuales" <?php
    if ($datos_cotizacion->tota_o_parcial == "despachos mensuales") {
        echo 'selected="true"';
    }
    ?>>despachos mensuales</option>
                    <option value="despachos bimensuales" <?php
    if ($datos_cotizacion->tota_o_parcial == "despachos bimensuales") {
        echo 'selected="true"';
    }
    ?>>despachos bimensuales</option>
                    <option value="despachos trimestrales" <?php
    if ($datos_cotizacion->tota_o_parcial == "despachos trimestrales") {
        echo 'selected="true"';
    }
    ?>>despachos trimestrales</option>                        
<?php } else { ?>                    
                    <option value="Total" <?php
    if ($_POST["tota_o_parcial"] == "Total") {
        echo 'selected="true"';
    }
    ?>>Total</option>
                    <option value="Parcial" <?php
    if ($_POST["tota_o_parcial"] == "Parcial") {
        echo 'selected="true"';
    }
    ?>>Parcial</option>
                    <option value="despachos semanales" <?php
    if ($_POST["tota_o_parcial"] == "despachos semanales") {
        echo 'selected="true"';
    }
    ?>>despachos semanales</option>
                    <option value="despachos mensuales" <?php
    if ($_POST["tota_o_parcial"] == "despachos mensuales") {
        echo 'selected="true"';
    }
    ?>>despachos mensuales</option>
                    <option value="despachos bimensuales" <?php
    if ($_POST["tota_o_parcial"] == "despachos bimensuales") {
        echo 'selected="true"';
    }
    ?>>despachos bimensuales</option>
                    <option value="despachos trimestrales" <?php
    if ($_POST["tota_o_parcial"] == "despachos trimestrales") {
        echo 'selected="true"';
    }
    ?>>despachos trimestrales</option>
<?php } ?>                     
...
foreach ($formas as $forma) {
    if (sizeof($datos_cotizacion) > 0) {
        ?>
                            <option value="<?php echo $forma->id; ?>" <?php
        if ($datos_cotizacion->forma_pago == $forma->id) {
            echo 'selected="true"';
        }
        ?>><?php echo $forma->forma_pago; ?></option>
    <?php } else { ?>                    
                            <option value="<?php echo $forma->id; ?>" <?php
        if ($_POST["forma_pago"] == $forma->id) {
            echo 'selected="selected"';
        }
        ?>><?php echo $forma->forma_pago; ?></option>
        <?php
...
<?php if (sizeof($datos_cotizacion) > 0) { ?>
                    <option value="NO" <?php
    if ($datos_cotizacion->comision_agencia == "NO") {
        echo 'selected="true"';
    }
    ?>>NO</option>
                    <option value="SI" <?php
    if ($datos_cotizacion->comision_agencia == "SI") {
        echo 'selected="true"';
    }
    ?>>SI</option>                    
<?php } else { ?>                    
                    <option value="NO" <?php
    if (isset($_POST["comision_agencia"]) == "NO") {
        echo 'selected="selected"';
    }
    ?>>NO</option>
                    <option value="SI" <?php
    if (isset($_POST["comision_agencia"]) == "SI") {
        echo 'selected="selected"';
    }
    ?>>SI</option>
<?php } ?>   
...
<?php if (sizeof($datos_cotizacion) > 0) { ?>
    <?php
    if ($datos_cotizacion->cliente_entrega_1 != null) {
        $chequeado_entrega_1 = 'checked="true"';
    } else {
        $chequeado_entrega_1 = '';
    }
    ?>
    ...
    <?php
    if (($datos_cotizacion->cliente_entrega_2 != '') or ( $datos_cotizacion->cliente_entrega_2 != null)) {
        $chequeado_entrega_2 = 'checked="true"';
    } else {
        $chequeado_entrega_2 = '';
    }
    ?>
    ...
    <?php
    if (($datos_cotizacion->cliente_entrega_3 != '') or ( $datos_cotizacion->cliente_entrega_3 != null)) {
        $chequeado_entrega_3 = 'checked="true"';
    } else {
        $chequeado_entrega_3 = '';
    }
    ?>
    ...
    <?php
    if (($datos_cotizacion->cliente_entrega_4 != '') or ( $datos_cotizacion->cliente_entrega_4 != null)) {
        $chequeado_entrega_4 = 'checked="true"';
    } else {
        $chequeado_entrega_4 = '';
    }
    ?>
    ...
    <?php
    if (($datos_cotizacion->cliente_entrega_6 != '') or ( $datos_cotizacion->cliente_entrega_6 != null)) {
        $chequeado_entrega_6 = 'checked="true"';
    } else {
        $chequeado_entrega_6 = '';
    }
    ?>
...
<?php } else { ?>                    
    <?php
    if ($_POST["cliente_entrega_1"] != null) {
        $chequeado_entrega_1 = 'checked="true"';
    } else {
        $chequeado_entrega_1 = '';
    }
    ?>
                <input type="checkbox" <?php echo $chequeado_entrega_1; ?> id="cliente_entrega_1" onclick="ver_archivo_cliente();" name="cliente_entrega_1" value="Información Digital">Información Digital<br>
    <?php
    if (($_POST["cliente_entrega_2"] != '') or ( $_POST["cliente_entrega_2"] != null)) {
        $chequeado_entrega_2 = 'checked="true"';
    } else {
        $chequeado_entrega_2 = '';
    }
    ?>
                <input type="checkbox" <?php echo $chequeado_entrega_2; ?> name="cliente_entrega_2" value="Muestra de Color">Muestra de Color<br>
    <?php
    if (($_POST["cliente_entrega_3"] != '') or ( $_POST["cliente_entrega_3"] != null)) {
        $chequeado_entrega_3 = 'checked="true"';
    } else {
        $chequeado_entrega_3 = '';
    }
    ?>
                <input type="checkbox" <?php echo $chequeado_entrega_3; ?> name="cliente_entrega_3" value="Producto a Contener">Producto a Contener<br>
    <?php
    if (($_POST["cliente_entrega_4"] != '') or ( $_POST["cliente_entrega_4"] != null)) {
        $chequeado_entrega_4 = 'checked="true"';
    } else {
        $chequeado_entrega_4 = '';
    }
    ?>
                <input type="checkbox" <?php echo $chequeado_entrega_4; ?>  name="cliente_entrega_4" value="Muestra Producto a Fabricar">Muestra Producto a Fabricar<br>
    <?php
    if (($_POST["cliente_entrega_6"] != '') or ( $_POST["cliente_entrega_6"] != null)) {
        $chequeado_entrega_6 = 'checked="true"';
    } else {
        $chequeado_entrega_6 = '';
    }
...
<?php } ?>                       
    ...
    <div class="control-group">
        <div class="form-actions">
            <input type="hidden" name="estado" value="<?php if ($datos_cotizacion->estado == '')
    echo 0;
else
    echo $datos_cotizacion->estado;
?>" />
<?php if ($datos_cotizacion->estado != 1) { ?>                  
                <input type="submit" onclick="cambiar_estado_cotizacion('0');" value="Guardar" class="btn <?php
    if ($datos_cotizacion->estado == 0) {
        echo 'btn-warning';
    }
    ?>"/>
                <input type="submit" onclick="cambiar_estado_cotizacion('1');" value="Liberar" class="btn <?php
    if ($datos_cotizacion->estado == 1) {
        echo 'btn-warning';
    }
    ?>"/>
                <input type="submit" onclick="cambiar_estado_cotizacion('2');" value="Rechazar" class="btn <?php
    if ($datos_cotizacion->estado == 2) {
        echo 'btn-warning';
    }
    ?>"/>
<?php } else { ?>  
