...
<div id="instrucciones">
    <span>En la "Repeticion sin Cambios" no se puede cambiar nada a excepcion de las cantidades.</span><br />
</div>
<div id="contenidos">
...
<?php echo form_open_multipart(null, array('onsubmit'=>'comprueba_extension(this.form, this.form.file.value)','class' => 'form-horizontal','name'=>'form','id'=>'form')); ?>
   ...
   <!-- /Migas -->
	<div class="page-header"><h3>Solicitud de Cotización sin Cambios</h3>
	</div>
    
    <div class="control-group">
		<label class="control-label" for="usuario">Cliente <strong style="color: red;">(*)</strong></label>
		<div class="controls">
                    <select barniz name="cliente" onchange="BuscarMoldesRegistradosCliente(this.value,'molde_select_cliente');BuscarFormaPagoCliente(this.value,'sub_forma_pago');BuscarBuscarVendedorCliente(this.value,'sub_vendedor');" style="width: 500px;">
...
-->
    ...
    <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly" name="vendedor">
                    <?php
                      if (sizeof($datos_cotizacion)>0)
                      {
    ...
    <div class="control-group">
		...
		<div class="controls">
                    <select readonly="readonly" name="condicion_del_producto" onchange="llamarDetalleCondicion(this.value);condicionParaMoldes(this.value);llamarlink(this.value);">
                    ...
                    <?php  if (sizeof($datos_cotizacion)>0)
                      {  
                        ...
                        ?>
                            ...
                            <option value="1" style="font-weight:bold" selected="true">Buscar Repetición?</option>
    ...
    <input type="hidden" name="pegado_migrado" value="<?php echo $datos_cotizacion->pegado_migrado; ?>"/>
    <input type="hidden" name="margen_migrado" value="<?php echo $datos_cotizacion->margen_migrado; ?>"/>
    <input type="hidden" name="precio_1" value="<?php echo $datos_cotizacion->precio_1; ?>"/>
    <input type="hidden" name="precio_migrado" value="<?php echo $datos_cotizacion->precio_migrado; ?>"/>
    <input type="hidden" name="precio_2" value="<?php echo $datos_cotizacion->precio_2; ?>"/>
    <input type="hidden" name="precio_3" value="<?php echo $datos_cotizacion->precio_3; ?>"/>
    <input type="hidden" name="precio_4" value="<?php echo $datos_cotizacion->precio_4; ?>"/>
    <input type="hidden" name="dias_de_entrega" value="<?php echo $datos_cotizacion->dias_de_entrega; ?>"/>
   ...
   <?php //echo "</pre>"?>
    <div class="control-group">
		...
		<div class="controls">
                    <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                    <input style="width: 500px;" type="text" name="producto" readonly="true" placeholder="Descripción del Producto" value="<?php echo $datos_cotizacion->producto; ?>"  onchange="ValidarNombreProducto();"/>
                      <?php } else {?>
			<input style="width: 500px;" type="text" name="producto" readonly="true"  placeholder="Descripción del Producto" value="<?php echo set_value("producto")?>"  onchange="ValidarNombreProducto();"/>
                    <?php } ?>
     ...
     <div class="control-group">
		...
		<div class="controls">
                    <select name="acepta_excedentes" style="width: 100px;" onchange="aceptaExcedentes();" onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
                            <option value="">Seleccione.....</option>
                      <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                      ...
                      <?php } else {?>                    
                            <option value="SI" <?php if(isset($_POST["acepta_excedentes"]) and $_POST["acepta_excedentes"]=='SI'){echo 'selected="selected"';}?>>SI</option>
                            <option value="NO" <?php if(isset($_POST["acepta_excedentes"]) and $_POST["acepta_excedentes"]=='NO'){echo 'selected="selected"';}?>>NO</option>
                    <?php } ?>                       
	...
	<div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly" name="vb_maquina" style="width: 100px;" onchange="aceptaExcedentes123();"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
                    <option value="">Seleccione.....</option>
                      <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                      ...
                      <?php } else {?>          
                            <option value="SI" <?php if(isset($_POST["vb_maquina"]) and $_POST["vb_maquina"]=='SI'){echo 'selected="selected"';}?>>SI</option>
                            <option value="NO" <?php if(isset($_POST["vb_maquina"]) and $_POST["vb_maquina"]=='NO'){echo 'selected="selected"';}?>>NO</option>                            
                    <?php } ?>                       
                </select> 
           <!-- <span id="acepta_excedentes">Acepta excedentes mas o menos 10%</span> -->
           <!-- <input type="hidden" name="acepta_excedentes_extra" value="Acepta pagar extra por cantidad exacta" readonly="true" /> -->
    ...
    <div class="control-group">
		...
		<div class="controls">
                      <?php  if (sizeof($datos_cotizacion)>0) {   ?>
			<textarea readonly="readonly" id="contenido4s" name="obs" placeholder="Observaciones"><?php echo $datos_cotizacion->comentario_medidas;?></textarea>
                      <?php } else {?>                    
			<textarea readonly="readonly" id="contenido4s" name="obs" placeholder="Observaciones"><?php if(isset($_POST["obs"])){echo $_POST["obs"];}?></textarea>
                    <?php } ?>                        
		</div>
	</div>
    ...
    <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="piezas_adicionales" class="chosen-select" onchange="carga_ajax_obtenerInfoPiezas(this.value,'infoNueva');">
	  ...
	  <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="piezas_adicionales2" class="chosen-select" onchange="carga_ajax_obtenerInfoPiezas(this.value,'infoNueva2');">
                    <option value="0">No lleva.....</option>
                      <?php  
                      $piezas=$this->cotizaciones_model->getPiezasAdicionales();
                      if (sizeof($datos_cotizacion)>0) {   
	  ...
	  <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="piezas_adicionales3" class="chosen-select" onchange="carga_ajax_obtenerInfoPiezas(this.value,'infoNueva3');">
                <option value="0">No lleva.....</option>
                      <?php  
                      $piezas=$this->cotizaciones_model->getPiezasAdicionales();
                      if (sizeof($datos_cotizacion)>0) {   
     ...
     <div class="control-group">
		...
		<div class="controls">
                    <?php                      
                      if (sizeof($datos_cotizacion)>0) {  ?>                     
			<textarea readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" id="contenido5" name="comentario_piezas_adicionales" placeholder="Observaciones"><?php echo $datos_cotizacion->comentario_piezas_adicionales;?></textarea>
                    <?php } else { ?>  
			<textarea readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" id="contenido5" name="comentario_piezas_adicionales" placeholder="Observaciones"><?php if(isset($_POST["comentario_piezas_adicionales"])){echo $_POST["comentario_piezas_adicionales"];}?></textarea>
                    <?php }  ?>  
		</div>
	</div>
    ...
    <div id="referencia">
		...
		<div class="controls">
			<!--<select name="select_estan_los_moldes" style="width: 300px;" onchange="estanLosMoldes(this.value);condicionParaMoldesGenericos(this.value);">-->
                        <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="select_estan_los_moldes" style="width: 300px;" onchange="estanLosMoldes(this.value);">
                            <?php  if (sizeof($datos_cotizacion)>0) {  ?>                      
                                <option value="">Seleccione.....</option>
                                <option value="NO" <?php if($datos_cotizacion->estan_los_moldes=="NO"){echo 'selected="selected"';}?>>NO</option>
                                <option value="NO LLEVA"<?php if($datos_cotizacion->estan_los_moldes=="NO LLEVA"){echo 'selected="selected"';}?>>NO LLEVA</option>
                            ...
                            <?php } else { ?>  
                                ...
                                <option value="NO LLEVA" <?php if(isset($_POST["select_estan_los_moldes"]) and $_POST["select_estan_los_moldes"]=='NO LLEVA'){echo 'selected="selected"';}?>>NO LLEVA</option>
	...
	<?php 
        ...
        if(($datos_cotizacion->estan_los_moldes=="NO") || ($datos_cotizacion->estan_los_moldes=="NO LLEVA"))
        {
        ...
        else
        {
            ...
            elseif (($_POST["select_estan_los_moldes_genericos"]=='SI') && ($_POST["select_estan_los_moldes_no_genericos_clientes"]=='NO'))
            {    
//                echo 1;
...
//            print_r($moldes_seleccionado);
	...
	<div class="control-group" id="div_estan_los_moldes_generico" <?php echo $ver_molde_generico; ?>
		...
		<div class="controls">
		    ...
		    <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="select_estan_los_moldes_genericos" style="width: 300px;" onchange="estanLosMoldes(this.value);">
                    <option value="">Seleccione.....</option>
                    <?php if (sizeof($datos_cotizacion)>0)  { ?>
                    ...
                    <div id="molde_select">
                          <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="molde_generico" id="molde_generico" style="width: 400px;" onchange="carga_ajax5('<?php echo base_url();?>moldes/detalle_ajax',this.value,'div_moldes')";>
                            <option value="0">Seleccione.....</option>
                              <?php
	...
	<div class="control-group" id="div_estan_los_moldes_clientes" <?php echo $ver_molde_cliente; ?>>
		...
		<div class="controls">
			...
			<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="select_estan_los_moldes_no_genericos_clientes" style="width: 300px;" onchange="estanLosMoldes(this.value);">
                        <option value="">Seleccione.....</option>
                        <?php if (sizeof($datos_cotizacion)>0)  { ?>
                            <option value="SI" <?php if(($datos_cotizacion->estan_los_moldes=='SI') || ($datos_cotizacion->estan_los_moldes=='MOLDE REGISTRADOS DEL CLIENTE') || ($datos_cotizacion->estan_los_moldes=="MOLDE GENERICO")){echo 'selected="true"';}?>>SI</option> 
                            <option value="NO" <?php if($datos_cotizacion->estan_los_moldes=="NO"){echo 'selected="true"';}?>>NO</option>
                        <?php } else { ?>
                            <option value="SI" <?php if(isset($_POST["select_estan_los_moldes_no_genericos_clientes"]) && $_POST["select_estan_los_moldes_no_genericos_clientes"]=='SI'){echo 'selected="selected"';}?>>SI</option> 
                            <option value="NO" <?php if(isset($_POST["select_estan_los_moldes_no_genericos_clientes"]) && $_POST["select_estan_los_moldes_no_genericos_clientes"]=='NO'){echo 'selected="selected"';}?>>NO</option>
                        <?php }  ?>   
                    </select> 
                    <?php // $moldes=$this->moldes_model->getMoldesClientes($datos_cotizacion->id_cliente); ?>

                    <div id="molde_select_cliente">
                          <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="molde_registrado" id="molde_registrado" style="width: 400px;" onchange="carga_ajax5('<?php echo base_url();?>moldes/detalle_ajax',this.value,'div_moldes')";>
                            <option value="0">Seleccione......</option>
                              <?php
                              $error_molde=false;
                              if (sizeof($datos_cotizacion)>0) 
    ...
    <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" style="width: 400px;" name="datos_tecnicos" onchange="carga_ajax4('<?php echo base_url();?>cotizaciones/materialidad',this.value,'materialidad');">
                <option value="">Seleccione.....</option>
                <?php
    ...
    <div id="materialidad">
          ...
          <div class="control-group">
    		...
    		<div class="controls">
    		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="materialidad_1">
                    <option value="0">Seleccione......</option>
                    <?php
                    $tapas=$this->materiales_model->getMaterialesSelectCartulina();
                    foreach($tapas as $tapa){
                    if (sizeof($datos_cotizacion)>0) {  ?>                
                        <option value="<?php echo $tapa->id?>" <?php if($datos_cotizacion->id_mat_placa1==$tapa->id){echo 'selected="true"';}?>><?php echo $tapa->gramaje?> ( <?php echo $tapa->materiales_tipo?> - $<?php echo $tapa->precio?> ) (<?php echo $tapa->reverso?>)</option>
                    <?php } else { ?>
                        <option value="<?php echo $tapa->id?>"<?php if($tapa->id==$_POST["materialidad_1"]){echo 'selected="true"';}?>><?php echo $tapa->gramaje?> ( <?php echo $tapa->materiales_tipo?> - $<?php echo $tapa->precio?> ) (<?php echo $tapa->reverso?>)</option>
                    <?php }
                    }
                    ?>
                </select>
        ...
        ?>
    		...
    		<div class="controls">
                    <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="materialidad_2">
                    <option value="0">Seleccione......</option>
                    <?php
                    $tapas=$this->materiales_model->getMaterialesSelectOnda();
                    foreach($tapas as $tapa){
                    if (sizeof($datos_cotizacion)>0) {  ?>                
                        <option value="<?php echo $tapa->id?>" <?php if($datos_cotizacion->id_mat_onda2==$tapa->id){echo 'selected="true"';}?>><?php echo $tapa->gramaje?> ( <?php echo $tapa->materiales_tipo?> - $<?php echo $tapa->precio?> ) (<?php echo $tapa->reverso?>)</option>
                    <?php } else { ?>
                        <option value="<?php echo $tapa->id?>"<?php if($tapa->id==$_POST["materialidad_2"]){echo 'selected="true"';}?>><?php echo $tapa->gramaje?> ( <?php echo $tapa->materiales_tipo?> - $<?php echo $tapa->precio?> ) (<?php echo $tapa->reverso?>)</option>
                    <?php }
                    }
                    ?>
                </select>
        ...
        ?>        
    		...
    		<div class="controls">
    		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="materialidad_3">
                    <option value="0">Seleccione......</option>
                    <?php
                    $tapas=$this->materiales_model->getMaterialesSelectOnda();
                    foreach($tapas as $tapa){
                    if (sizeof($datos_cotizacion)>0) {  ?>                
                        <option value="<?php echo $tapa->id?>" <?php if($datos_cotizacion->id_mat_liner3==$tapa->id){echo 'selected="true"';}?>><?php echo $tapa->gramaje?> ( <?php echo $tapa->materiales_tipo?> - $<?php echo $tapa->precio?> ) (<?php echo $tapa->reverso?>)</option>
                    <?php } else { ?>
                        <option value="<?php echo $tapa->id?>"<?php if($tapa->id==$_POST["materialidad_3"]){echo 'selected="true"';}?>><?php echo $tapa->gramaje?> ( <?php echo $tapa->materiales_tipo?> - $<?php echo $tapa->precio?> ) (<?php echo $tapa->reverso?>)</option>
                    <?php }
                    }
                    ?>                    
                </select>
   ...
   <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="solicita_muestra" style="width: 100px;" onchange="detalleDeMuestra();">
                <option value="">Seleccione.....</option>
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
    ...
    <div id="div_muestra" style="display: none;">
     <div class="control-group">
		...
		<div class="controls">
                    <?php                      
                      if (sizeof($datos_cotizacion)>0) {  ?>  
			<textarea readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" id="contenidos4" name="detalle_de_muestra" placeholder="Detalle de Muestra"><?php echo $datos_cotizacion->detalle_de_muestra;?></textarea>
                    <?php } else { ?>  
			<textarea readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" id="contenidos4" name="detalle_de_muestra" placeholder="Detalle de Muestra"><?php echo $_POST["detalle_de_muestra"] ?></textarea>
                    <?php }  ?>                      
		</div>
	</div>
   </div>
    ...
    <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="colores" onchange="cromalin(this.value);" >
                <option value="">Seleccione.....</option>
                <?php
                for($i=0;$i<9;$i++)
                { 
     ...
     <div class="control-group" id="producto">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="colores_metalicos">
                <option value="">Seleccione.....</option>
                <?php
                    for($i=0;$i<3;$i++)
                    { 
 ...
 <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" id="tiene_fondo" name="tiene_fondo" style="width: 100px;" onchange="llevaFondoCotizacion(this.value);">
                    <option value="">Seleccione</option>
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
...
<!--        <div class="control-group">
		...
		<div class="controls">
                    <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" id="proceso_fondo" name="proceso_fondo" style="width: 100px;">
                        <option value="">Seleccione.....</option>
                        <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                        ...
                        <?php } else {?>                    
                                <option value="CO" <?php if(sset($_POST["proceso_fondo"])=="CO"){echo 'selected="selected"';}?>>Al Corte</option>
		...
		<div class="controls">
		<select name="lleva_barniz" style="width: 200px;" onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
                    <option value="">Seleccione.....</option>
                        <?php  if (sizeof($datos_cotizacion)>0) {   ?>
...
<div class="control-group" id="reserva_barniz" <?php if($datos_cotizacion->reserva_barniz==""){echo "hidden=true";}?>onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
...
<div class="control-group"  id="cala_caucho" <?php if($datos_cotizacion->cala_caucho==""){echo "hidden=true";}?>>
    ...
    <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="acabado_impresion_1">
                <option value="">Seleccione.....</option>
                <?php
    ...
    <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="acabado_impresion_2" onchange="procesosInternos();">
                <option value="">Seleccione.....</option>
                <?php
                foreach($internos as $interno) { ?>
                        <?php  if (sizeof($datos_cotizacion)>0) {   ?>
     ...
     <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="acabado_impresion_3" onchange="procesosInternos();">
                <option value="">Seleccione.....</option>
                <?php
                foreach($internos as $interno) { ?>
                        <?php  if (sizeof($datos_cotizacion)>0) {   ?>
    ...
    <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="acabado_impresion_4" onchange="procesosExternos();carga_ajax_obtenerInfo(this.value,'infoNuevaAddSin')">
                <option value="">Seleccione.....</option>
                <?php
                ...
                ?>                  
            </select><a href="#" id="infoNuevaAddSin"></a>
    ...
    <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="acabado_impresion_5" onchange="procesosExternos();carga_ajax_obtenerInfo(this.value,'infoNuevaAddSin2')">
                <option value="">Seleccione.....</option>                    
                <?php
                foreach($externos as $externo) { ?>
                        <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                ...
                ?>  
            </select><a href="#" id="infoNuevaAddSin2"></a>
       ...
       <div class="control-group">
		...
		<div class="controls">
		<select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="acabado_impresion_6" onchange="procesosExternos();carga_ajax_obtenerInfo(this.value,'infoNuevaAddSin3');">
                <option value="">Seleccione.....</option>                    
                <?php
                foreach($externos as $externo) { ?>
                        <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                ...
                ?>  
            </select><a href="#" id="infoNuevaAddSin3"></a>
	...
	<div class="control-group">
		<label class="control-label" for="usuario">Hacer Cromalín</label>
		<div class="controls">
                <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="hacer_cromalin" style="width: 100px;" id="dir">
                <option value="">Seleccione.....</option>
                        <?php  if (sizeof($datos_cotizacion)>0) {   ?>
    ...
    <div class="control-group">
		...
		<div class="controls">
                    <select name="folia" style="width: 100px;" onchange="cambiaFolia_Cotizacion(); cambiaFolia();" onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
                        <?php
                        if(sizeof($datos_cotizacion)==0)
                        {
                    ...
                    <select name="folia_se" id="folia_se" onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
                        <?php
                        if(sizeof($datos_cotizacion)==0)
                        {
                        ?>
                        ...
                        <select name="folia1_proceso_seletec"  style="width: 500px;" onchange="carga_ajax_obtenerInfoProcesos(this.value,'pt1');" onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
                            <option value="0">Seleccione......</option>
                            <?php
                    ...
                    <div id="folia1_molde_selected" style="display:<?php if($procesos_especiales=="SI"){echo 'block';}else{echo 'none';}?>;"> <strong>&nbsp;Proceso Especial (molde): &nbsp;</strong>                      
                        <select name="folia1_molde_selected"  style="width: 500px;" onchange="carga_ajax_obtenerInfoProcesos(this.value,'ptm1');" onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
                            <option value="0">Seleccione......</option>
                            <?php
                            $procesos=$this->procesosespeciales_model->getProcesosEspecialesCotizacion();                
                            foreach($procesos as $pro)
    ...
    <div class="control-group">
		...
		<div class="controls">
		<select name="folia_2" style="width: 100px;" onchange="cambiaFolia2_Cotizacion(); cambiaFolia2();" onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
                <?php
                if(sizeof($datos_cotizacion)==0)
                {
    ...
    <div class="control-group">
            ...
            <div class="controls">
		<select name="folia_3" style="width: 100px;" onchange="cambiaFolia3_Cotizacion(); cambiaFolia3();" onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
                <?php
                if(sizeof($datos_cotizacion)==0)
                {
    ...
    <div class="control-group">
		...
		<div class="controls">
		<select name="cuno" style="width: 100px;" onchange="cambiaCuno_Cotizacion();cambiaCuno();" onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
                <?php
                if(sizeof($datos_cotizacion)==0)
                {
    ...
    <div class="control-group">
		...
		<div class="controls">
		<select name="cuno_2" style="width: 100px;" onchange="cambiaCuno2_Cotizacion(); cambiaCuno2();" onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o">
                <?php
                if(sizeof($datos_cotizacion)==0)
                {
    ...
    <h3>Instrucciones de Terminación</h3>
     ...
     <div class="control-group">
		...
		<div class="controls">
            <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="producto_se_entrega_armado">
                <option value="">Seleccione.....</option>  
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
    ...
    <div class="control-group">
		...
		<div class="controls">
            <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="tiene_desgajado">
                <option value="">Seleccione.....</option>        
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
    ...
    <div class="control-group">
		...
		<div class="controls">
                    <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="montaje_pieza_especial" onchange="mostrarTextoPiezaEspecial(this.value,'mostrar_texto_pieza_especial');">
                        <option value="">Seleccione.....</option>                
                        <?php  if (sizeof($datos_cotizacion)>0) {   ?>
      ...
      <div class="control-group">
		...
		<div class="controls">
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
			<textarea readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" id="pegado_instrucciones" name="pegado_instrucciones" onkeypress="nextOnEnter(this,event);"  placeholder="Observaciones"><?php echo $datos_cotizacion->pegado_instrucciones; ?></textarea>
                <?php } else {?>                    
			<textarea readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" id="pegado_instrucciones" name="pegado_instrucciones" onkeypress="nextOnEnter(this,event);"  placeholder="Observaciones"><?php echo $_POST["pegado_instrucciones"]; ?></textarea>
                <?php } ?>                       
		</div>
	</div>
    ...
    <div class="control-group" style="display:none;">
		...
		<div class="controls">
            <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="cantidad_especifica_sino">
                <option value="">Seleccione.....</option>                
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
    ...
    <div class="control-group">
		...
		<div class="controls">
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                    <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="text" value="<?php echo $datos_cotizacion->cantidad_especifica?>" name="cantidad_especifica" id="cantidad_especifica" onkeypress="return soloNumeros(event)" placeholder="0" onblur="invalidarCheck();"/><br>
                <?php } else {?>                    
                    <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="text" value="<?php echo $_POST["cantidad_especifica"]?>" name="cantidad_especifica" id="cantidad_especifica" onkeypress="return soloNumeros(event)" placeholder="0" onblur="invalidarCheck();"/><br>
                <?php } ?>       
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                    <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" <?php if($datos_cotizacion->cantidad_especifica==0) echo "checked" ?> onClick="if(this.checked == true){invalidarCantidadaEmpaquetar();}" type="checkbox"  id="cantidad_a_empaquetar_a_criterio" name="cantidad_a_empaquetar_a_criterio" value="cantidad_a_empaquetar_a_criterio">Cantidad a Empaquetar a Criterio de Empresa
                <?php } else {?>                    
                    <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" <?php if($_POST["cantidad_especifica"]==0) echo "checked" ?> onClick="if(this.checked == true){invalidarCantidadaEmpaquetar();}" type="checkbox"  id="cantidad_a_empaquetar_a_criterio" name="cantidad_a_empaquetar_a_criterio" value="cantidad_a_empaquetar_a_criterio">Cantidad a Empaquetar a Criterio de Empresa
                <?php } ?>                       
		</div>
	</div>
     ...
     <div class="control-group">
		...
		<div class="controls">
            <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="envasado">
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                    <option value="">Seleccione.....</option>                
    ...
    <h3>Detalles de Despacho</h3>
      ...
      <div class="control-group">
		...
		<div class="controls">
            <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="despacho_fuera_de_santiago">
                <option value="">Seleccione.....</option>                
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
      ...
      <div class="control-group">
		...
		<div class="controls">
            <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="retira_cliente">
                <option value="">Seleccione.....</option>                
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
      ...
      <div class="control-group">
		...
		<div class="controls">
                <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o"  name="tota_o_parcial" id="tota_o_parcial" onchange="fn_cb_totalOparcial(this.value,'cantidadesDespacho')">
                <option value="">Seleccione.....</option>       
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
    ...
    <h3>Comercial</h3>
     ...
     <div class="control-group">
		...
		<div class="controls" >
                    <select readonly="readonly"  class="chosen-select" onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="forma_pago">
                            <option value="0">Seleccione.....</option>
                            <?php
                            $formas=$this->clientes_model->getFormasPago();
                            $cliente_forma_pago_id=$this->clientes_model->getClientePorIdBasico($datos_cotizacion->id_cliente);
                            foreach($formas as $forma)
                            {
                                if ($cliente_forma_pago_id->id_forma_pago>0) {   ?>
                                    <option value="<?php echo $forma->id; ?>" <?php if($cliente_forma_pago_id->id_forma_pago==$forma->id){echo 'selected="true"';}?>><?php echo '('.$forma->dias.' Dias ) '.$forma->forma_pago; ?></option>
                                <?php } else {?>                                      
    ...
    <div class="control-group">
		...
		<div class="controls">
            <select readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" name="comision_agencia">
                <option value="">Seleccione.....</option>                
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
     ...
     <div class="control-group">
		...
		<div class="controls">
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                        <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="text" value="<?php echo $datos_cotizacion->costo_comercial?>" name="costo_comercial" id="costo_comercial"  onkeypress="nextOnEnter(this,event);return soloNumeros(event)" onblur="formatear(this.value,this.id)" value="0" />
                <?php } else {?>                    
                        <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="text" value="<?php echo $_POST["costo_comercial"]?>" name="costo_comercial" id="costo_comercial"  onkeypress="nextOnEnter(this,event);return soloNumeros(event)" onblur="formatear(this.value,this.id)" value="0" />
                <?php } ?>                 
      ...
      <div class="control-group">
		...
		<div class="controls">
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                        <?php  if ($datos_cotizacion->cliente_entrega_1!=null) {  $chequeado_entrega_1='checked="true"'; } else { $chequeado_entrega_1=''; } ?>
                           <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="checkbox" <?php echo $chequeado_entrega_1; ?> id="cliente_entrega_1" onclick="ver_archivo_cliente();" name="cliente_entrega_1" value="Información Digital">Información Digital<br>
                        <?php  if (($datos_cotizacion->cliente_entrega_2!='') or ($datos_cotizacion->cliente_entrega_2!=null)) {  $chequeado_entrega_2='checked="true"'; } else { $chequeado_entrega_2=''; } ?>
                            <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="checkbox" <?php echo $chequeado_entrega_2; ?> name="cliente_entrega_2" value="Muestra de Color">Muestra de Color<br>
                        <?php  if (($datos_cotizacion->cliente_entrega_3!='') or ($datos_cotizacion->cliente_entrega_3!=null)) {  $chequeado_entrega_3='checked="true"'; } else { $chequeado_entrega_3=''; } ?>
                            <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="checkbox" <?php echo $chequeado_entrega_3; ?> name="cliente_entrega_3" value="Producto a Contener">Producto a Contener<br>
                        <?php  if (($datos_cotizacion->cliente_entrega_4!='') or ($datos_cotizacion->cliente_entrega_4!=null)) {  $chequeado_entrega_4='checked="true"'; } else { $chequeado_entrega_4=''; } ?>
                            <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="checkbox" <?php echo $chequeado_entrega_4; ?>  name="cliente_entrega_4" value="Muestra Producto a Fabricar">Muestra Producto a Fabricar<br>
                        ...
                        <?php  if (($datos_cotizacion->cliente_entrega_6!='') or ($datos_cotizacion->cliente_entrega_6!=null)) {  $chequeado_entrega_6='checked="true"'; } else { $chequeado_entrega_6=''; } ?>
                            <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="checkbox" <?php echo $chequeado_entrega_6; ?>   name="cliente_entrega_6" value="Nada">Nada<br>
                            Otro: <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="text" value="<?php echo $datos_cotizacion->cliente_entrega_5; ?>" name="cliente_entrega_5" />                    
                <?php } else {?>                    
                        ...
                        <?php  if (($_POST["cliente_entrega_6"]!='') or ($_POST["cliente_entrega_6"]!=null)) {  $chequeado_entrega_6='checked="true"'; } else { $chequeado_entrega_6=''; } ?>
                            <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="checkbox" <?php echo $chequeado_entrega_6; ?>   name="cliente_entrega_6" value="Nada">Nada<br>
                            Otro: <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="text" value="<?php echo $_POST["cliente_entrega_5"]; ?>" name="cliente_entrega_5" />  
                <?php } ?>              
        ...
        <div id="archivo_cliente" <?php  if (($_POST["cliente_entrega_1"]==null) or ($datos_cotizacion->cliente_entrega_1!=null)) { ?> style="display:none;" <?php } ?>>            
                ...
                <div class="control-group">
                        ...
                        <div class="controls">
                            <input readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" type="file" id="file" name="file" /><strong> Debe ser archivos Tipo PDF </strong>
                                <div id="nomarch"></div>
                        </div>
                </div>	            
        </div>    
    ...
    <div class="control-group" style="display: none;">
		...
		<div class="controls">
                <?php  if (sizeof($datos_cotizacion)>0) {   ?>
			<textarea readonly="readonly"  onfocus="t=this.innerHTML;if(window.ActiveXObject)o=this.outerHTML;this.blur()" onchange="this.innerHTML=t;if(window.ActiveXObject)this.outerHTML=o" id="contenido6" name="glosa" placeholder="Observaciones"><?php echo $datos_cotizacion->costo_comercial; ?></textarea>
                <?php } else {?>                    
			<textarea readonly="readonly" id="contenido6" name="glosa" placeholder="Observaciones"><?php echo set_value('glosa'); ?></textarea>
                <?php } ?>                       
		</div>
	</div>
