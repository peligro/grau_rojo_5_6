<?php
    ...
    $totaltrabajosespeciales=$folia1->precio+$folia2->precio+$folia3->precio+$cuno1->precio+$cuno2->precio;
    
    echo "total trabajosespeciales".$totaltrabajosespeciales."<br>";
    echo "procesos especiales:".$procesosespeciales;
    /****************************************************/
...
//                                            exit;
               ...
               <tr>
                    ...
                    <td class="celda_3">&nbsp;<?php  echo $folia1->valor_venta; ?>&nbsp;</td>
                    <td class="celda_3">&nbsp;<?php  if ($fv1=="Nuevo"){ if($folia1->unidades_de_venta=='Monto Fijo'){$costo1=$folia1->valor_venta;}else{$costo1=$folia1->valor_venta*$cantidad_4+50000;} echo number_format($costo1,0,'','.'); }else{if($folia1->unidades_de_venta=='Monto Fijo'){$costo1=$folia1->valor_venta;}else{$costo1=$folia1->valor_venta*$cantidad_4;} echo number_format($costo1,'0','','.');} ?>&nbsp;</td>
                </tr>
               <?php } ?>        
               ...
               <tr>
                    ...
                    <td class="celda_3">&nbsp;<?php  echo $folia2->valor_venta; ?>&nbsp;</td>
                    <td class="celda_3">&nbsp;<?php  if ($fv2=="Nuevo"){ if($folia2->unidades_de_venta=='Monto Fijo'){$costo2=$folia2->valor_venta;}else{$costo2=$folia2->valor_venta*$cantidad_4+50000;} echo number_format($costo2,0,'','.'); }else{if($folia2->unidades_de_venta=='Monto Fijo'){$costo2=$folia2->valor_venta;}else{$costo2=$folia2->valor_venta*$cantidad_4;} echo number_format($costo2,'0','','.');} ?>&nbsp;</td>
                </tr>
               <?php } ?>        
               ...
               <tr>
                    ...
                    <td class="celda_3">&nbsp;<?php  echo $folia3->valor_venta; ?>&nbsp;</td>
                    <td class="celda_3">&nbsp;<?php  if ($fv3=="Nuevo"){ if($folia3->unidades_de_venta=='Monto Fijo'){$costo3=$folia3->valor_venta;}else{$costo3=$folia3->valor_venta*$cantidad_4+50000;} echo number_format($costo3,0,'','.'); }else{if($folia3->unidades_de_venta=='Monto Fijo'){$costo3=$folia3->valor_venta;}else{$costo3=$folia3->valor_venta*$cantidad_4;} echo number_format($costo3,'0','','.');} ?>&nbsp;</td>
                </tr>
               <?php } ?>        
               ...
               <tr>
                    ...
                    <td class="celda_3">&nbsp;<?php  echo $cuno1->valor_venta; ?>&nbsp;</td>
                    <td class="celda_3">&nbsp;<?php  if ($fv4=="Nuevo"){ if($cuno1->unidades_de_venta=='Monto Fijo'){$costo4=$cuno1->valor_venta;}else{$costo4=$cuno1->valor_venta*$cantidad_4+50000;} echo number_format($costo4,0,'','.'); }else{if($cuno1->unidades_de_venta=='Monto Fijo'){$costo4=$cuno1->valor_venta;}else{$costo4=$cuno1->valor_venta*$cantidad_4;} echo number_format($costo4,'0','','.');} ?>&nbsp;</td>
                </tr>
               <?php } ?>        
               ...
               <tr>
                    ...
                    <td class="celda_3">&nbsp;<?php  echo $cuno2->valor_venta; ?>&nbsp;</td>
                    <td class="celda_3">&nbsp;<?php  if ($fv5=="Nuevo"){ if($cuno2->unidades_de_venta=='Monto Fijo'){$costo5=$cuno2->valor_venta;}else{$costo5=$cuno2->valor_venta*$cantidad_4+50000;} echo number_format($costo5,0,'','.'); }else{if($cuno2->unidades_de_venta=='Monto Fijo'){$costo5=$cuno2->valor_venta;}else{$costo5=$cuno2->valor_venta*$cantidad_4;} echo number_format($costo5,'0','','.');} ?>&nbsp;</td>
                </tr>
               <?php } ?>        
               <tr>
                ...
                <tr>
                    ...
                    <td>&nbsp;&nbsp;<?php if($hoja->valor_externo!=0){ $externos_produccion=$externos_produccion+$hoja->valor_externo+$costo1+$costo2+$costo3+$costo4+$costo5; echo number_format($hoja->valor_externo,0,'','.');}else{  $externos_produccion=$precio_total_4+$precio_total_5+$precio_total_6+$costo1+$costo2+$costo3+$costo4+$costo5; echo number_format($externos_produccion,0,'','.');} ?>&nbsp;&nbsp;<a href="<?php echo base_url()?>hoja/trabajos_externos/<?php echo $id?>/4" class="fancybox fancybox.ajax"><img src="<?php echo base_url()?>public/frontend/images/edit.png" class="img_16" /></a><input type="hidden" name="valor_externo" value="<?php if($hoja->valor_externo!=0){ echo number_format($hoja->valor_externo,0,'','.');}else{ echo number_format($externos_produccion,0,'','.');} ?>" /></td>
                </tr>                   
                <tr>
...
<!--                                        <tr>
                     ...
                     <tr>
                      ...
                      <tr>
					  <?php
                                                                //$m=$fotomecanica->materialidad_datos_tecnicos;
//                                                                echo $tamano1."<br>";
//                                                                echo $tamano2."<br>";;
//                                                                echo $tapaGramaje3."<br>";
//                                                                echo $tapaPrecio3."<br>";
//                                                                function monto_respaldo($m,$cantidad,$unidades,$tamano1,$tamano2,$tapaGramaje2){
//                                                                    
//                                                                 if($m == 'Cartulina-cartulina'){
//                                                                $calculo1 = ($cantidad/$unidades);                                                                
//                                                                $calculo2 = $calculo1*0.04;
//                                                                $calculo3 = $calculo1 + $calculo2 + 104;
//                                                                $costoPlacaKilo2 = $calculo3;
//                                                                
//                                                               echo $valorPlacaKilo2 = ($costoPlacaKilo2*$tamano1*$tamano2*$tapaGramaje2)/10000000;
//                                                                $totalPlacaKilo2 = $calculo3;
//                                                                
//                                                                }else{
//                                                                 
//                                                                }
//                                                                }
                                                                //monto_respaldo($m,$datos->cantidad_1,$ing->unidades_por_pliego,$tamano1,$tamano2,$tapaGramaje2);
                                                               // echo "<h1>".$tapaGramaje3."</h1>";
...
//                            echo $complemento."www<br>";
//                            echo $valorCorte2."<br>";
//                            echo $totalEmplacado2."<br>";
//                            echo $totalMontajeMolde."<br>";
//                            echo $totalTroquelado2."<br>";
//                            echo $totalPegado."<br>";
//                            echo $totalDespacho2."despacho2<br>";
...
//                            echo $valor_acepeta_exce."ww<br>";
				...
				if(sizeof($hoja)==0)
							...
							<?php
//							echo $vcostoFinanciero->precio."<h1>A</h1><br>";
//                                                        echo $totalProduccion2."<h1>B</h1><br>";
//                                                        echo $totalDefi1."<h1>C</h1><br>";
//                                                        echo $totalPreImpresion."<h1>D</h1><br>";
//                                                        echo $margen."<h1>E</h1><br>";
//                            echo $totalMontajeMolde."<br>";
//                            echo $totalTroquelado2."<br>";
//                            echo $totalPegado."<br>";
//                            echo $totalDespacho."<br>";
                    ...
                    <tr>
                     ...
                     <tr>
                                        ...
                                        if(sizeof($hoja)==0) { 
                                                ...
                                                $totalPegado=$datos->cantidad_2*$pegado_migrado*$variablePegado->precio;                                               
                                          ?>
                                                <td class="celda_33"><?php if($datos->pegado_migrado == ''){echo '30';}else{echo $datos->pegado_migrado;}?><a href="<?php echo base_url()?>hoja/pegado/<?php echo $id?>/<?php echo $pagina?>" class="fancybox fancybox.ajax"><img src="<?php echo base_url()?>public/frontend/images/edit.png" class="img_16" /></a><input type="hidden" name="pegado2" placeholder="Descripcion técnica" value="<?php echo $datos->pegado_migrado?>" /></td>
					  <?php } else { 
                                                $variablePegado=$this->variables_cotizador_model->getVariablesCotizadorPorId(21);
                                                $totalPegado=$datos->cantidad_2*$hoja->pegado*$variablePegado->precio;                                              
                                          ?>
                                                <td class="celda_33"><?php if($hoja->pegado == ''){echo '30';}else{echo $hoja->pegado;}?><a href="<?php echo base_url()?>hoja/pegado/<?php echo $id?>/<?php echo $pagina?>" class="fancybox fancybox.ajax"><img src="<?php echo base_url()?>public/frontend/images/edit.png" class="img_16" /></a><input type="hidden" name="pegado2" placeholder="Descripcion técnica" value="<?php echo $hoja->pegado?>" /></td>
					<?php }  ?>                                            
                    ...
                    ?>
                     <tr>
                                        ...
                                        if(sizeof($hoja)==0) { 
                                          ...
                                          ?>
                                                <td class="celda_33"><?php if($datos->pegado_migrado == ''){echo '30';}else{echo $datos->pegado_migrado;}?><a href="<?php echo base_url()?>hoja/pegado/<?php echo $id?>/<?php echo $pagina?>" class="fancybox fancybox.ajax"><img src="<?php echo base_url()?>public/frontend/images/edit.png" class="img_16" /></a><input type="hidden" name="pegado3" placeholder="Descripcion técnica" value="<?php echo $datos->pegado_migrado?>" /></td>
					  <?php } else { 
                                                $variablePegado=$this->variables_cotizador_model->getVariablesCotizadorPorId(21);
                                                $totalPegado=$datos->cantidad_3*$hoja->pegado*$variablePegado->precio;                                              
                                          ?>
                                                <td class="celda_33"><?php if($hoja->pegado == ''){echo '30';}else{echo $hoja->pegado;}?><a href="<?php echo base_url()?>hoja/pegado/<?php echo $id?>/<?php echo $pagina?>" class="fancybox fancybox.ajax"><img src="<?php echo base_url()?>public/frontend/images/edit.png" class="img_16" /></a><input type="hidden" name="pegado3" placeholder="Descripcion técnica" value="<?php echo $hoja->pegado?>" /></td>
					<?php }  ?>                                            
...
//						
                    ...
                    <tr>
                                        ...
                                        if(sizeof($hoja)==0) { 
                                          ...
                                          ?>
                                                <td class="celda_33"><?php if($datos->pegado_migrado == ''){echo '30';}else{echo $datos->pegado_migrado;}?><a href="<?php echo base_url()?>hoja/pegado/<?php echo $id?>/<?php echo $pagina?>" class="fancybox fancybox.ajax"><img src="<?php echo base_url()?>public/frontend/images/edit.png" class="img_16" /></a><input type="hidden" name="pegado4" placeholder="Descripcion técnica" value="<?php echo $datos->pegado_migrado?>" /></td>
					  <?php } else { 
                                                $variablePegado=$this->variables_cotizador_model->getVariablesCotizadorPorId(21);
                                                $totalPegado=$datos->cantidad_4*$hoja->pegado*$variablePegado->precio;                                              
                                          ?>
                                                <td class="celda_33"><?php if($hoja->pegado == ''){echo '30';}else{echo $hoja->pegado;}?><a href="<?php echo base_url()?>hoja/pegado/<?php echo $id?>/<?php echo $pagina?>" class="fancybox fancybox.ajax"><img src="<?php echo base_url()?>public/frontend/images/edit.png" class="img_16" /></a><input type="hidden" name="pegado4" placeholder="Descripcion técnica" value="<?php echo $hoja->pegado?>" /></td>
					<?php }  ?>                                            
