   ...
   echo "<br>";
       ...
       * */
       ...
       //  echo $can1;exit();
		...
		//echo $enteroBarniz;exit();
         ...
         if(($fotomecanica->fot_lleva_barniz!='') && ($fotomecanica->fot_lleva_barniz!='Nada'))
         {
            $cantidadBarniz2=$datos->cantidad_3-1000;
            ...
            }else
            {
               ...
               $enteroBarniz2=($datos->cantidad_3/$ing->unidades_por_pliego);
	...
	if (($fotomecanica->acabado_impresion_6!='')  && ($fotomecanica->acabado_impresion_6!=17))      
       ...
       // echo $ing->materialidad_datos_tecnicos;exit;
        ...
        {
             $mermaEmplacadoArray=$this->variables_cotizador_model->getVariablesCotizadorPorId(35);
             $emplacado2= $cantidad_3; /*Valor x dividido por Unidad por pliego*/
        ...
        }else
        {
            ...
            $mermaTroqueladoArray=$this->variables_cotizador_model->getVariablesCotizadorPorId(36);
            if (($datos->cantidad_3>0) and ($ing->unidades_por_pliego>0))
                $troquelado2=$datos->cantidad_3/$ing->unidades_por_pliego;
            else 
                $troquelado2=0;
        ...
        $costosporlacado2=(35000+(52*($datos->cantidad_3/$ing->unidades_por_pliego)));
...
<!--                                            SI ES SI EN COTIZACION-->
                          ...
                          if ($hoja->margen!="") {
                            $valorFinal=(($totalValorUnitario/(100-$hoja->margen))/100)*10000;
                              ...
                              if($datos->margen_migrado!=0 || $datos->margen_migrado!=null){
                                  ...
                                  $valorFinal2xxx = $this->cotizaciones_model->CantidadPorXXX($id,$datos->cantidad_3,2);
                ...
                <?php
                          ...
                          //  echo "<h1>$valorFinal2xxx</h1>";
                            ...
                            $var2 = (((($totalProduccion2+$totalDefi1+$totalPreImpresion)*0.085)+(($totalProduccion2+$totalDefi1+$totalPreImpresion)*0.085)+($totalProduccion2+$totalDefi1+$totalPreImpresion))/((100-$margen)/100))/$datos->cantidad_3;
            ...
            $tira3=((($datos->cantidad_3/$ing->unidades_por_pliego)+$sum)*$factor_rango+$base_imprenta->precio )*($fotomecanica->colores+$barniz2)."<br>";
            $tira4=((($datos->cantidad_3/$ing->unidades_por_pliego)+$sum)*$factor_rango+$base_imprenta->precio)*($fotomecanica->colores+$barniz2)*(1*$recargo800Array->precio/100);
            ...
            $valorCorte2=(((($datos->cantidad_3/$ing->unidades_por_pliego)*1.04)+104)*4.5);
           ...
           $costoOnda2=(((($datos->cantidad_3/$ing->unidades_por_pliego)*1.04)+104))."<br>";
            ...
            if($fotomecanica->estan_los_moldes == 'NO LLEVA')
	    {
           ...
           $totalEmplacado4=$valorEmplacadado*$costoOnda4."<br>";
                            ...
                            $dos=($datos->cantidad_3/$ing->unidades_por_pliego)+$sum2."<br />";
                            ...
                            //$v2= number_format((($datos->cantidad_3/$ing->unidades_por_pliego)*1.04)+104,0,'','.');
                            $v2= number_format((($datos->cantidad_3/$ing->unidades_por_pliego)*1.04)+104,0,'','.');
                           ...
                           $totalDefi1=$totalPlacaKilo2+((($v2*$tamano1*$tamano2*$GramosMetroCuadrado)/10000)*$costo_kilo);
                            ...
                            $TotalPiezasAdicionales2=$datos->cantidad_3*$piezaAdacionalValor1;
...
<!--                            <tr>
                                ...
                                <td class="celda_3"><?php //if($datos->cantidad_3 == 1){ echo 0;}else{echo number_format($datos->cantidad_3,0,"",".");}?> <a href="<?php //echo base_url()?>hoja/cantidad2/<?php// echo $id?>/2" class="fancybox fancybox.ajax"><img src="<?php //echo base_url()?>public/frontend/images/edit.png" class="img_16" /></a></td>
...
<!--                            <tr>
                               ...
                               // echo number_format(((((($totalProduccion2+$totalDefi1+$totalPreImpresion)*0.085)+(($totalProduccion2+$totalDefi1+$totalPreImpresion)*0.085)+($totalProduccion2+$totalDefi1+$totalPreImpresion))/((100-$margen)/100))/$datos->cantidad_3),0,'','.');}?></td>
                                <td class="celda_3">VALOR FINAL</td>
                                <td class="celda_3"><?php //if($datos->cantidad_3 == 1){ echo 0;}else{
...
<!--                            <tr>
                                ...
                                <td class="celda_3">
                                <?php //echo number_format((((($vcostoFinanciero->precio/30)*30)+100)/100)*((((($totalProduccion2+$totalDefi1+$totalPreImpresion)*0.085)+(($totalProduccion2+$totalDefi1+$totalPreImpresion)*0.085)+($totalProduccion2+$totalDefi1+$totalPreImpresion))/((100-$margen)/100))/$datos->cantidad_3),0,'','.') ?>
                            ...
                            <?php
                            $vfinanciero2=number_format((((($vcostoFinanciero->precio/30)*30)+100)/100)*((((($totalProduccion2+$totalDefi1+$totalPreImpresion)*0.085)+(($totalProduccion2+$totalDefi1+$totalPreImpresion)*0.085)+($totalProduccion2+$totalDefi1+$totalPreImpresion))/((100-$margen)/100))/$datos->cantidad_3),0,'','.');
...
<!--                            <tr>
                                ...
                                <td class="celda_3"><?php //if(sizeof($hoja)==0){if($datos->cantidad_3 == 1){echo 0;}else{if( $valorEmpresa2 == 0){echo number_format($valorFinanciado2,0,'','.');}else{echo $vfinanciero2;}}}else{echo number_format($hoja->valor_empresa_2,0,'','.');}?> <a href="<?php// echo base_url()?>hoja/valor_empresa_2/<?php //echo $id?>/2" class="fancybox fancybox.ajax"><img src="<?php //echo base_url()?>public/frontend/images/edit.png" class="img_16" /></a></td>
                            ...
                            <input type="hidden" name="valor_empresa_22" value="<?php if($datos->cantidad_3 == 1){
                                echo 0;
                            }
                            else{
                                    if( $valorEmpresa2 == 0){
...
<!--                    <div id="cantidad">
                    Valor por : <?php //echo number_format($datos->cantidad_3,0,"",".")?> <a href="<?php //echo base_url()?>hoja/cantidad/<?php //echo $id?>/<?php //echo $pagina?>" class="fancybox fancybox.ajax"><img src="<?php //echo base_url()?>public/frontend/images/edit.png" class="img_16" /></a>
                    </div>-->
...
//                                                echo "1==============";
                                        ...
                                        if($maquina=="Máquina Roland 800")
                                         {
                                            $tira1=((($datos->cantidad_3/$ing->unidades_por_pliego)+$sum)*$factor_rango+$base_imprenta->precio )*($fotomecanica->colores+$barniz2);
                                            $recargo800Array=$this->variables_cotizador_model->getVariablesCotizadorPorId(34);
                                            $tira2=((($datos->cantidad_3/$ing->unidades_por_pliego)+$sum)*$factor_rango+$base_imprenta->precio)*($fotomecanica->colores+$barniz2)*(1*$recargo800Array->precio/100);
                                            //echo $recargo800Array->precio."<br>".$tira1."<br>".$tira2;exit;
                                             
                                         }else
                                         {
                                            $tiraje=((($datos->cantidad_3/$ing->unidades_por_pliego)+$sum)*$factor_rango+$base_imprenta->precio )*($fotomecanica->colores+$barniz2);  
               ...
               ?>
                ...
                ?>
                    ...
                    <div>
                        ...
                        <?php
                            if (($datos->cantidad_3>0) and ($ing->unidades_por_pliego>0))
                                $costoPlacaKilo=($datos->cantidad_3/$ing->unidades_por_pliego)+$sum;
                            else 
                                $costoPlacaKilo=0;
                            $valorPlacaKilo=($costoPlacaKilo*$tamano1*$tamano2*$tapaGramaje)/10000000;
                            $totalPlacaKilo=$valorPlacaKilo*$tapaPrecio;
...
//                                echo $this->db->last_query();
                    ...
                    <?php
                        ...
                        {
                           if (($datos->cantidad_3>0) and ($ing->unidades_por_pliego>0))
                                $costoOndaKilo=((($datos->cantidad_3/$ing->unidades_por_pliego)*1.04)+100)+4;
                            else 
                                $costoOndaKilo=0;                            
                        }else
                        {
                           if (($datos->cantidad_3>0) and ($ing->unidades_por_pliego>0))
                                $costoOndaKilo=(($datos->cantidad_3/$ing->unidades_por_pliego)+100)+4;
                            else 
                                $costoOndaKilo=0;                               
                        }
                        ...
                        $costoOndaKilo1=((($datos->cantidad_3/$ing->unidades_por_pliego)*1.04)+100)+4;
                        $costoOndaKilo2=(($datos->cantidad_3/$ing->unidades_por_pliego)+$emplacado+$troquelado);
			...
			$moldeTroquel=0;
					...
					// $TotalPiezasAdicionales = $piezaAdacionalTotal1 + $piezaAdacionalTotal2 + $piezaAdacionalTotal3;
                     ...
                     <tr>
                                           ...
                                           <?php number_format($hoja->valor_extra*$datos->cantidad_3,0,'','.') ?>
...
//                                $this->db->update("hoja_de_costos_datos",$arreglo6);
                           ...
                           <?php $porcentajeTotalCorte =$totalPlacaKilo*7/100; number_format((($totalPlacaKilo*7)/(100)),0,'','.')?>
                             <?php
								...
								if($fotomecanica->materialidad_datos_tecnicos == 'Cartulina-cartulina')
								{
                                                                $costoPlacaKilo2 = ($datos->cantidad_3/$ing->unidades_por_pliego);
                      ...
                      <tr>
                        ...
                        if($fotomecanica->materialidad_datos_tecnicos == 'Cartulina-cartulina')
                         ...
                         <?php
                           $totalTotal=$totalMateriaPrima+$totalPreImpresion+$totalProduccion+$totalCostosVarios;                                               
                           $totalValorUnitario=$totalTotal/$datos->cantidad_3;
...
<!--                          <tr>
                                ...
                                <td class="celda_3"><?php //echo number_format($datos->cantidad_3,0,'','.')?></td>
                            </tr>                                
                          <tr>
           ...
           $totalEmplacado4=$valorEmplacadado*$costoOnda4."<br>";
                        ...
                        <table id="tabla_detalle">
                            ...
                            <tr>
                                <td class="celda_3">VALOR FINAL</td>
                                <td class="celda_3"><?php if($datos->cantidad_3 == 1){ echo 0;}else{
                                echo number_format($valorFinal,0,'','.');}?></td>
                                <td class="celda_3">VALOR FINAL</td>
                                <td class="celda_3"><?php if($datos->cantidad_3 == 1){ echo 0;}else{
                                echo number_format(((((($totalProduccion3+$totalDefi2+$totalPreImpresion)*0.085)+(($totalProduccion3+$totalDefi2+$totalPreImpresion)*0.085)+($totalProduccion3+$totalDefi2+$totalPreImpresion))/((100-$margen)/100))/$datos->cantidad_3),0,'','.');}?></td>
                                <td class="celda_3">VALOR FINAL</td>
				...
				if(sizeof($hoja)==0)
                            ...
                            <tr>
                                ...
                                <?php //echo number_format((((($vcostoFinanciero->precio/30)*30)+100)/100)*((((($totalProduccion2+$totalDefi1+$totalPreImpresion)*0.085)+(($totalProduccion2+$totalDefi1+$totalPreImpresion)*0.085)+($totalProduccion2+$totalDefi1+$totalPreImpresion))/((100-$margen)/100))/$datos->cantidad_3),0,'','.') ?>
                                <?php //echo number_format($cf2,0,'','.') ?>
                                <?php echo number_format($valorFinanciado,0,'','.') ?>
                                </td>
                                <td class="celda_3">VALOR FINANCIERO 3</td>
                                <td class="celda_3">
                                <?php //echo number_format((((($vcostoFinanciero->precio/30)*30)+100)/100)*((((($totalProduccion3+$totalDefi2+$totalPreImpresion)*0.085)+(($totalProduccion3+$totalDefi2+$totalPreImpresion)*0.085)+($totalProduccion3+$totalDefi2+$totalPreImpresion))/((100-$margen)/100))/$datos->cantidad_3),0,'','.') ?>
                            ...
                            <input type="hidden" name="valor_empresa_2" value="<?php if($datos->cantidad_3 == 1){
                                echo 0;
                            }
                            else{
                                    if( $valorEmpresa2 == 0){
...
//                                    exit($fotomecanica->materialidad_datos_tecnicos."aquiii");       
                                    if (($datos->cantidad_3>0) and ($ing->unidades_por_pliego>0))
                                        $cantidad_cajas = ($datos->cantidad_3 / $ing->unidades_por_pliego) + 104;                                    
                                    else $cantidad_cajas = 104;                                    
