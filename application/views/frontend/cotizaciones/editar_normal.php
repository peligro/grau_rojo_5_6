    ...
    <div class="control-group">
		...
		<div class="controls">
                    <select name="cliente" onchange="recetear_cliente_add_cotizacion();BuscarMoldesRegistradosCliente(this.value,'molde_select_cliente');BuscarFormaPagoCliente(this.value,'sub_forma_pago');BuscarBuscarVendedorCliente(this.value,'sub_vendedor');" class="chosen-select" style="width: 500px;">
                        ...
                        { 
                            foreach($clientes as $cliente){ ?>
                                <option value="<?php echo $cliente->id?>" <?php if(($_POST["cliente"]) and $_POST["cliente"]==$cliente->id){echo 'selected="true"';}?>><?php echo $cliente->razon_social?> <?php if($cliente->estado==2){echo '(BLOQUEADO)';} if($cliente->id_region==0){echo '( Info. Incompleta)';}?></option>
                            <?php } 
                        } ?>
    ...
    <div id="materialidad">
        ...
        ?>        
    		...
    		<select name="materialidad_3">
                    ...
                    foreach($tapas as $tapa){
                    if (sizeof($datos_cotizacion)>0) {  ?>                
                    <option value="<?php echo $tapa->nombre?>" <?php if(strtoupper(trim($datos_cotizacion->materialidad_3))==strtoupper(trim($tapa->nombre))){echo 'selected="true"';}?>><?php echo $tapa->gramaje?> ( <?php echo $tapa->materiales_tipo?> - $<?php echo $tapa->precio?> ) (<?php echo $tapa->reverso?>)</option>
                    <?php } else { ?>
                        <option value="<?php echo $tapa->nombre?>"<?php if($tapa->nombre==$_POST["materialidad_3"]){echo 'selected="true"';}?>><?php echo $tapa->gramaje?> ( <?php echo $tapa->materiales_tipo?> - $<?php echo $tapa->precio?> ) (<?php echo $tapa->reverso?>)</option>
                    <?php }
                    }
                    ?>                    
                </select>
...
<!--        <div class="control-group">
		...
		<select name="lleva_barniz" style="width: 200px;">
                    <option value="">Seleccione.....</option>
                        <?php  if (sizeof($datos_cotizacion)>0) {   ?>
                                <option value="Barniz Acuoso" <?php if($datos_cotizacion->lleva_barniz=="Barniz Acuoso"){echo 'selected="true"';}?>>Barniz Acuoso</option>
                        ...
                        <?php } else {?>                    
                                <option value="Barniz Acuoso" <?php if(($_POST["lleva_barniz"])=="Barniz Acuoso"){echo 'selected="selected"';}?>>Barniz Acuoso</option>
     ...
     <div class="control-group">
		...
		<div class="controls" >
			<select name="forma_pago">
                            ...
                            {
                                if (sizeof($datos_cotizacion)>0) {   ?>
                                    <option value="<?php echo $forma->id; ?>" <?php if($datos_cotizacion->forma_pago==$forma->id){echo 'selected="true"';}?>><?php echo $forma->forma_pago; ?></option>
                                <?php } else {?>                    
