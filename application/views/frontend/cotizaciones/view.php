   ...
   <!-- /Migas -->
	<div class="page-header"><h3>Editar Solicitud de Cotización N° <?php echo number_format($id,0,'','.');?></h3></div>
     ...
     <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="cliente" class="chosen-select">
...
-->
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="vendedor">
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="condicion_del_producto" onchange="llamarDetalleCondicion(this.value);">
   ...
   <!--productos asociados--> 
    ...
    <div class="control-group">
		...
		<div class="controls">
			<input disabled="disabled" type="text" name="producto" placeholder="Descripción del Producto" value="<?php echo $datos->producto; ?>" onkeypress="return alpha_con_numeros(event)" /><input disabled="disabled" type="hidden" name="producto_id" value="0" />
		</div>
	</div>
     ...
     <div class="control-group" id="producto">
		...
		<div class="controls">
			<input disabled="disabled" type="text" name="can1" style="width: 100px;" id="can1" onkeypress="return soloNumeros(event)" placeholder="Cantidad 1" value="<?php echo $datos->cantidad_1; ?>" /> - <input disabled="disabled" type="text" name="can2" id="can2" style="width: 100px;" onkeypress="return soloNumeros(event)" placeholder="Cantidad 2" value="<?php echo $datos->cantidad_2; ?>" /> - <input disabled="disabled" type="text" name="can3" id="can3" style="width: 100px;" onkeypress="return soloNumeros(event)" placeholder="Cantidad 3" value="<?php echo $datos->cantidad_3; ?>" /> - <input disabled="disabled" type="text" value="0" name="can4" id="can4" style="width: 100px;" onkeypress="return soloNumeros(event)" placeholder="Cantidad 4" value="<?php echo $datos->cantidad_4; ?>" />
		</div>
	</div>
     ...
     <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="acepta_excedentes" style="width: 100px;" onchange="aceptaExcedentes();">
            ...
            <input disabled="disabled" type="hidden" name="acepta_excedentes_extra" value="<?php echo $datos->acepta_excedentes_extra?>" />
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="piezas_adicionales">
	...
	<label class="control-label" for="usuario">Están los moldes?</label>
		<div class="controls">
			<select disabled="disabled" name="estan_los_moldes" style="width: 100px;" onchange="estanLosMoldes(this.value);">
                        ...
                        <select disabled="disabled" name="molde" id="molde" onchange="carga_ajax5('<?php echo base_url();?>moldes/detalle_ajax',this.value,'div_moldes');">
                            <?php
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="datos_tecnicos" onchange="carga_ajax4('<?php echo base_url();?>cotizaciones/materialidad',this.value,'materialidad');" class="chosen-select">
                <?php
    ...
    <div id="materialidad">
          ...
          <div class="control-group">
    		...
    		<div class="controls">
    			<select disabled="disabled" name="materialidad_1" class="chosen-select">
                    <option value="0">Seleccione......</option>
                    <?php
         ...
         <div class="control-group">
    		...
    		<div class="controls">
    			<select disabled="disabled" name="materialidad_2" class="chosen-select">
                    <option value="0">Seleccione......</option>
                    <?php
                    foreach($tapas as $tapa)
                    {
        ...
        <div class="control-group">
    		...
    		<div class="controls">
    			<select disabled="disabled" name="materialidad_3" class="chosen-select">
                    <option value="0">Seleccione......</option>
                    <?php
                    foreach($tapas as $tapa)
                    {
    ...
    <input disabled="disabled" type="hidden" name="materialidad_4" value="No Aplica" />         
    <input disabled="disabled" type="hidden" name="materialidad_eleccion" value="tapa_mono" />
   ...
   <div class="control-group">
		...
		<div class="controls">
				<select disabled="disabled" name="solicita_muestra" style="width: 100px;" onchange="detalleDeMuestra();">
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="colores">
                <?php
                for($i=0;$i<9;$i++)
                {
                    ?>
     ...
     <div class="control-group" id="producto">
		...
		<div class="controls">
			<select disabled="disabled" name="colores_metalicos">
                <?php
                for($i=0;$i<3;$i++)
                {
                    ?>
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="acabado_impresion_1">
                <?php
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="acabado_impresion_2">
                <?php
                foreach($internos as $interno)
                {
                ?>
     ...
     <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="acabado_impresion_3" onchange="procesosInternos();">
                <?php
                foreach($internos as $interno)
                {
                ?>
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="acabado_impresion_4">
                <?php
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="acabado_impresion_5">
                <?php
                foreach($externos as $externo)
                {
                ?>
       ...
       <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="acabado_impresion_6" onchange="procesosExternos();">
                <?php
                foreach($externos as $externo)
                {
                ?>
    ...
    <div class="control-group">
		...
		<div class="controls">
			<input disabled="disabled" type="checkbox" id="dir" name="hacer_cromalin" value="si" />
		</div>
	</div>
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="folia" style="width: 100px;" onchange="cambiaFolia();">
                <option value="SI">SI</option>
                <option value="NO" selected="selected">NO</option>
            </select> 
            <span id="folia_se_a" style="display: none;">
            <select disabled="disabled" name="folia_se">
                <option value="Nuevo">Nuevo</option>
                <option value="Repetición">Repetición</option>
            </select>
            </span>
            <span id="folia_se_b" style="display: block;">
                <input disabled="disabled" type="text" name="folia_se" value="No Lleva" readonly="true" />
            </span>
		</div>
	</div>
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="folia_2" style="width: 100px;" onchange="cambiaFolia2();">
                <option value="SI">SI</option>
                <option value="NO" selected="selected">NO</option>
            </select> 
           <span id="folia_se_2_a" style="display: none;">
            <select disabled="disabled" name="folia_se_2">
                <option value="Nuevo">Nuevo</option>
                <option value="Repetición">Repetición</option>
            </select>
            </span>
            <span id="folia_se_2_b" style="display: block;">
                <input disabled="disabled" type="text" name="folia_se_2" value="No Lleva" readonly="true" />
            </span>
     ...
     <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="folia_3" style="width: 100px;" onchange="cambiaFolia3();">
                <option value="SI">SI</option>
                <option value="NO" selected="selected">NO</option>
            </select> 
            <span id="folia_se_3_a" style="display: none;">
            <select disabled="disabled" name="folia_se_3">
                <option value="Nuevo">Nuevo</option>
                <option value="Repetición">Repetición</option>
            </select>
            </span>
            <span id="folia_se_3_b" style="display: block;">
                <input disabled="disabled" type="text" name="folia_se_3" value="No Lleva" readonly="true" />
            </span>
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="cuno" style="width: 100px;" onchange="cambiaCuno();">
                <option value="SI">SI</option>
                <option value="NO" selected="selected">NO</option>
            </select> 
            <span id="cuno_se_a" style="display: none;">
            <select disabled="disabled" name="cuno_se">
                <option value="Nuevo">Nuevo</option>
                <option value="Repetición">Repetición</option>
            </select>
            </span>
            <span id="cuno_se_b" style="display: block;">
                <input disabled="disabled" type="text" name="cuno_se" value="No Lleva" readonly="true" />
            </span>
    ...
    <div class="control-group">
		...
		<div class="controls">
			<select disabled="disabled" name="cuno_2" style="width: 100px;" onchange="cambiaCuno2();">
                <option value="SI">SI</option>
                <option value="NO" selected="selected">NO</option>
            </select> 
            
            <span id="cuno_se_2_a" style="display: none;">
            <select disabled="disabled" name="cuno_se_2">
                <option value="Nuevo">Nuevo</option>
                <option value="Repetición">Repetición</option>
            </select>
            </span>
            <span id="cuno_se_2_b" style="display: block;">
                <input disabled="disabled" type="text" name="cuno_se_2" value="No Lleva" readonly="true" />
            </span>
		</div>
	</div>
    ...
    <h3>Instrucciones de Terminación</h3>
     ...
     <div class="control-group">
		...
		<div class="controls">
            <select disabled="disabled" name="producto_se_entrega_armado">
                <option value="SI">SI</option>
                <option value="NO" selected="selected">No</option>
            </select>
    ...
    <div class="control-group">
		...
		<div class="controls">
            <select disabled="disabled" name="tiene_desgajado">
                <option value="SI">SI</option>
                <option value="NO" selected="selected">No</option>
            </select>
    ...
    <div class="control-group">
		...
		<div class="controls">
            <select disabled="disabled" name="montaje_pieza_especial">
                <option value="SI">SI</option>
                <option value="NO" selected="selected">No</option>
            </select>
            <br />
            <input disabled="disabled" type="text" onkeypress="nextOnEnter(this,event);" />
     ...
     <div class="control-group">
		...
		<div class="controls">
            <select disabled="disabled" name="cantidad_especifica_sino">
    ...
    <div class="control-group">
		...
		<div class="controls"><!--onkeypress="nextOnEnter(this,event);" -->
            ...
            <input disabled="disabled" type="text" name="cantidad_especifica" id="cantidad_especifica" onkeypress="return soloNumeros(event)" placeholder="0" />
     ...
     <div class="control-group">
		...
		<div class="controls">
            <select disabled="disabled" name="envasado">
                <option value="">Seleccione......</option>                   
    ...
    <h3>Detalles de Despacho</h3>
      ...
      <div class="control-group">
		...
		<div class="controls">
            <select disabled="disabled" name="despacho_fuera_de_santiago">
                <option value="SI">SI</option>
                <option value="NO" selected="selected">NO</option>
            </select>
      ...
      <div class="control-group">
		...
		<div class="controls">
            <select disabled="disabled" name="retira_cliente">
                <option value="SI">SI</option>
                <option value="NO" selected="selected">NO</option>
            </select>
      ...
      <div class="control-group">
		...
		<div class="controls">
                    <select disabled="disabled" name="tota_o_parcial" id="tota_o_parcial" onchange="fn_cb_totalOparcial(this.value,'cantidadesDespacho')">
       ...
       <div class="control-group" id="producto">
		...
		<div class="controls" >
			...
			<input disabled="disabled" type="text" name="can_despacho_1" style="width: 100px;" id="can_despacho1" onkeypress="return soloNumeros(event)" placeholder="%" onblur="validaParcial();" /> - <input disabled="disabled" type="text" name="can_despacho_2" style="width: 100px;" id="can_despacho_2" onkeypress="return soloNumeros(event)" placeholder="%" onblur="validaParcial();" /> - <input disabled="disabled" type="text" name="can_despacho_3" style="width: 100px;" id="can_despacho_3" onkeypress="return soloNumeros(event)" placeholder="%" onblur="validaParcial();" />
                </div>
                </div>
        </div>
    <h3>Comercial</h3>
...
//                    echo $datos->forma_pago."hola";
                ?>
		<select disabled="disabled" name="forma_pago">
                <option value="0">Seleccione.....</option>
                <?php
    ...
    <div class="control-group">
		...
		<div class="controls">
            <select disabled="disabled" name="comision_agencia">
                <option value="SI">SI</option>
                <option value="NO" selected="selected">NO</option>
            </select>
     ...
     <div class="control-group">
		...
		<div class="controls">
            ...
            <input disabled="disabled" type="text" name="costo_comercial" id="costo_comercial"  onkeypress="nextOnEnter(this,event);return soloNumeros(event)" onblur="formatear(this.value,this.id)" value="0" />
    ...
    <h3>Cliente Entrega</h3>
      ...
      <div class="control-group">
		...
		<div class="controls">
            <select disabled="disabled" name="cliente_entrega" size="5" multiple="multiple">
    ...
    <div class="control-group">
		<div class="form-actions">
		 <input disabled="disabled" type="hidden" name="estado" />
			<input disabled="disabled" type="submit" value="Guardar" class="btn <?php if($ing->estado==0){echo 'btn-warning';}?>" />
		    <!--
<input disabled="disabled" type="button" value="Rechazar" class="btn <?php if($ing->estado==2){echo 'btn-warning';}?>" onclick="guardarFormularioAdd('2');" />
-->
            <!--
<input disabled="disabled" type="button" value="Liberar" class="btn <?php if($ing->estado==1){echo 'btn-warning';}?>" onclick="guardarFormularioAdd('1');" />
-->
		</div>
	</div>
