 ...
 <div class="control-group">
		...
		<div class="controls">
			<select name="estado" onchange="enviaSelect('produccion_fotomecanica',this.value);">
                ...
                <option value="1" <?php if($estado==1){echo 'selected="true"';}?>>Guardada</option>
                <option value="2" <?php if($estado==2){echo 'selected="true"';}?>>Liberada</option>
                <option value="3" <?php if($estado==3){echo 'selected="true"';}?>>Rechazada</option>
                <option value="4" <?php if($estado==4){echo 'selected="true"';}?>>Activa</option>
            </select>
		</div>
	</div>
</div>
<div>
	<a class="btn btn-danger pull-left" href="<?php echo base_url()?>produccion_listados/fotomecanica_por_estado_pdf/<?php echo $estado2?>" target="_blank"><i class="icon-file"></i> Exportar a PDF</a>
    <br /><br />
