...
<div class="control-group">
  ...
  <div class="control-group">
     ...
     <div class="control-group">
		...
		<div class="controls">
			<input type="text" id="titulo" name="precio1" value="<?php echo set_value("prercio1")?>" placeholder="Precio 1" />
		</div>
	</div>
  ...
  <div class="control-group">
		...
		<div class="controls">
			<input type="text" id="titulo" name="precio2" value="<?php echo set_value("prercio2")?>" placeholder="Precio 2" />
		</div>
	</div>
    
     <div class="control-group">
		<label class="control-label" for="usuario">Precio 3</label>
		<div class="controls">
			<input type="text" id="titulo" name="precio3" value="<?php echo set_value("prercio3")?>" placeholder="Precio 3" />
		</div>
	</div>
