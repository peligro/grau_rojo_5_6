...
<!-- Migas -->
    ...
    <div class="control-group">
		...
		<div class="controls">
		    <select name="estado">
                    ...
                    <option value="1" <?php if($datos->estado==1){echo 'selected="true"';}?>>Liberado</option>
            </select>
   ...
   <div class="control-group">
		...
		<div class="controls">
			<input type="text" id="titulo" name="contacto_empresa_ejecutante" value="<?php echo $datos->contacto_empresa_ejecutante?>" placeholder="Contacto de empresa ejecutante" />
		</div>
	</div>
		...
		<div class="controls">
			 <select class="form-control chosen-select" name="procesos">
                ...
                foreach($procesos as $proceso)
                {
                    ...
                    ?>
                    <option value="<?php echo $proceso->id?>" <?php if(sizeof($existe)>=1){echo 'selected="true"';}?>><?php echo $proceso->nombre?> ($<?php echo number_format($proceso->precio,0,"",".")?>) (<?php echo $proceso->descripcion?>)</option>
                    <?php
                }
                ?>
             </select>
