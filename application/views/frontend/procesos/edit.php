...
<!-- Migas -->
    <ol  class= "breadcrumb" >  
      ...
      <li><a href="<?php echo base_url()?>procesos/index/<?php echo $pagina?>">Procesos de Empresa &gt;&gt;</a></li>
      <li>Editar Procesos de Empresa</li>
    </ol>
   <!-- /Migas -->
	<div class="page-header"><h3>Editar Procesos de Empresa</h3></div>
  ...
  <div class="control-group">
		...
		<div class="controls">
			<input type="text" id="titulo" name="des" value="<?php echo $datos->descripcion?>" placeholder="Descripción" />
		</div>
	</div>
		...
		<div class="controls">
			<input type="text" id="titulo" name="precio" value="<?php echo $datos->precio?>" placeholder="Precio" />
		</div>
	</div>
