    ...
    <ol  class= "breadcrumb" >  
      ...
      switch($tipo)
      {
        case '1':
            ...
            <li>Bodega - Orden de Producción N° <?php echo $ordenDeCompra->id ?></li>
            <?php
        break;
        case '2':
            ?>
   ...
   <!-- /Migas -->
    <?php
      switch($tipo)
      {
        case '1':
            ?>
            <div class="page-header"><h3>Bodega - Orden de Producción N° <?php echo $ordenDeCompra->id ?></h3></div>
                <?php
...
de <?php echo $ordenDeCompra->cantidad_de_cajas?>                        
    ...
    <div class="control-group">
		<label class="control-label" for="usuario">Fecha de Entrega a Bodega <strong style="color: red;">(*)</strong></label>
		<div class="controls">                    
                <?php 
	...
	<div class="controls">
            <input type="text" id="cantidades_a_ingresar" name="cantidades_a_ingresar" value="<?php echo set_value_input($control,'cantidades_a_ingresar',$control->cantidades_a_ingresar);?>" placeholder="Cantidad a Ingresar" /> de<b> <?php if($control->total_cajas_pendientes==""){echo $ordenDeCompra->cantidad_de_cajas;}else{echo $control->total_cajas_pendientes;};?> Pendientes</b>
    ...
    <div class="control-group">
		<label class="control-label" for="usuario">Cantidad de Cajas en Bodega</label>
		<div class="controls">
