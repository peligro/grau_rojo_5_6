...
<!--        <span style="color: #ff0000; font-size: 12px;"><B>Activo</B></span>->        
        ...
        <span style="color: orange; font-size: 12px;"><B>Anulada</B> </span>->
        <span style="color: green; font-size: 12px;"><B>Cerrada</B> </span>->
...
<div class="page-header"><h3>Órdenes de Producción por Vendedor( <?php echo $cuantos?> en total)</h3><a href="<?php echo base_url().'produccion/cotizaciones_lista_cerradas/'.$list?>" target="_blank">Imprimir</a></div>
...
//        print_r($fotomecanica2);        
  ...
  <?php if ($archivo_cliente->archivo!=""){ ?>
        ...
        <td><?php echo "<span style='background-color:";if($dato->estado==3){echo 'green;';}else{echo 'orange;';} echo"' width:100px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>";?></td>
<!--        <td style="width: 40px"><?php //echo "<a href='#' onclick='colocar2($dato->id,document)' class='idc' val='".$dato->id."' data-toggle='modal' data-target='#myModalVendedor'><img src='".base_url()."public/frontend/images/edit.png' class='img_16' /></a>";?></td>-->
        <td style="width: 40px"><?php echo "<a href='#' onclick='colocar(this.id,document)' class='idco' id='".$dato->id."' val='".$dato->id."' data-toggle='modal' data-target='#myModalDespachar'><img src='".base_url()."public/frontend/images/edit.png' class='img_16 despacho' /></a>";?>
   ...
   <div class="modal fade" id="myModalDespachar" role="confirm" style="width: 500px">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Reversar la Orden de Cotizacion <b id="nro_de_cotizacion_despacho"></b></h4>
        </div>
        <div class="modal-body">
            <!--<form action="" method="post">-->
                <div class="form-group">    
                    <input id="numero_ctd" type="hidden" name="numero_ctd" />
                    <input id="operacion" type="hidden" name="operacion" value="1"/>
            </div>
        </div>
        <div class="modal-footer">
