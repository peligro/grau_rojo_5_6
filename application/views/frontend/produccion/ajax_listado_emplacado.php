...
//,ppp.total_o_parcial,ppp.can_despacho_1,ppp.can_despacho_2,ppp.can_despacho_3,ppp.total_pliegos_buenos")
?>
<div class="page-header"><h3>Listado de Producción Emplacado( <?php echo sizeof($datos)?> en total)</h3></div>
