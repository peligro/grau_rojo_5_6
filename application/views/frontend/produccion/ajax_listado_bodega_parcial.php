 ...
 if($this->session->userdata('id'))
        {
            ...
            $porpagina=10;
			$datos=$this->produccion_model->getBodegaParcialCotizacionPaginacion($pagina,$porpagina,"limit");
			$cuantos=$this->produccion_model->getBodegaParcialCotizacionPaginacion($pagina,$porpagina,"cuantos");
...
?>
<div class="page-header"><h3>Listado de Producción Bodega Parciales( <?php echo sizeof($datos)?> en total)</h3></div>
<table class="table table-bordered table-striped indice">
    ...
    ?>
		 ...
		 <td style="width: 20px;"><?php echo $dato->cantidades_a_ingresar?></td>
		 <td style="width: 20px;"><?php echo $dato->total_cajas_pendientes?></td>
		 <td style="width: 20px;"><?php echo $dato->cierra_la_orden?></td>
