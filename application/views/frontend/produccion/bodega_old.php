    ...
    <ol  class= "breadcrumb" >  
      ...
      switch($tipo)
      {
        case '1':
            ...
            <li>Bodega - Orden de Producción N° <?php echo $id?></li>
            <?php
        break;
        case '2':
            ?>
            <li><a href="<?php echo base_url()?>produccion/fast/<?php echo $pagina?>">Fast Track &gt;&gt;</a></li>
            <li>Bodega - Fast Track N° <?php echo $id?></li>
            <?php
        break;
      }
      ?>
   ...
   <!-- /Migas -->
    <?php
      switch($tipo)
      {
        case '1':
            ?>
            <div class="page-header"><h3>Bodega - Orden de Producción N° <?php echo $id?></h3></div>
            <ul>
                <?php
...
de <?php echo $ordenDeCompra->cantidad_de_cajas?>                        
        ...
        case '2':
            ?>
            <div class="page-header"><h3>Bodega - Fast Track N° <?php echo $id?></h3></div>
            <ul>
                <?php
    ...
    <div class="control-group">
		<label class="control-label" for="usuario">Fecha de Entrega a Bodega de Hoy<strong style="color: red;">(*)</strong></label>
		<div class="controls">                    
                <?php 
    ...
    <div class="control-group">
       <label class="control-label" for="usuario">Ingreso a Bodega de Hoy<strong style="color: red;">(*)</strong></label>
	<div class="controls">
            <input type="text" id="cantidades_a_ingresar" name="cantidades_a_ingresar" value="<?php echo set_value_input($control,'cantidades_a_ingresar',$control->cantidades_a_ingresar);?>" placeholder="Cantidad a ingresar" />            
        </div>
	</div>
    ...
    <div class="control-group">
		...
		<div class="controls">
            <input type="text" id="cantidad_de_cajas" name="cantidad_de_cajas" value="<?php echo $ordenDeCompra->cantidad_de_cajas;?>" placeholder="Cantidad de cajas" />
       </div>
	</div>
    ...
    <div class="control-group">
		...
		<div class="controls">
            <input type="text" name="unidades_por_paquete_oficial" value="<?php echo set_value_input($control,'unidades_por_paquete_oficial',$control->unidades_por_paquete_oficial);?>" placeholder="Unidades por paquete oficial" />
       </div>
	</div>
    ...
    <div class="control-group">
		...
		<div class="controls">
            <input type="text" name="unidades_paquete_efectivo" value="<?php echo set_value_input($control,'unidades_paquete_efectivo',$control->unidades_paquete_efectivo);?>" placeholder="Unidades por paquete efectivas que trae este ingreso" />
       </div>
	</div>
    ...
    <div class="control-group">
		<label class="control-label" for="usuario">Cantidad de cajas ya ingresadas</label>
		<div class="controls">
...
<!--    <div class="control-group">
    ...
    <div class="control-group">
	<label class="control-label" for="usuario">Total de cajas pendientes</label>
	<div class="controls">
            <input type="text" id="total_cajas_pendientes" name="total_cajas_pendientes" value="<?php if($control->total_cajas_pendientes==""){echo $ordenDeCompra->cantidad_de_cajas;}else{echo $control->total_cajas_pendientes;};?>" placeholder="Total de cajas pendientes" readonly="true" />
        </div>
    </div>
