 ...
 if($this->session->userdata('id'))
        {
            ...
            $porpagina=10;
			$datos=$this->produccion_model->getDesgajadoConCotizacionPaginacion($pagina,$porpagina,"limit");
			$cuantos=$this->produccion_model->getDesgajadoConCotizacionPaginacion($pagina,$porpagina,"cuantos");
