...
<table class="table table-bordered table-striped indice" id="datatable">
    ...
    <tr>
        ...
        <td><?php if($fotomecanica2->producto != ""){echo $fotomecanica2->producto.'<br />Cantidad: '.$orden->cantidad_de_cajas.'<br />Precio: '.$orden->precio;}else{echo $dato->producto.'<br />Cantidad: '.$orden->cantidad_de_cajas.'<br />Precio: '.$orden->precio;}?></td>
        ...
        <td style="text-align: right; width: 200px;">
            ...
            if(sizeof($fotomecanica)>0)
            {
                ...
                ?>
                <a href="<?php echo base_url()?>produccion/revision_fotomecanica/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Producción Fotomecánica"><span style="font-size: 10px;color:<?php echo $colorFotomecanica?>; font-weight: bold;">Producción Fotomecánica</span><i class="icon-film"></i></a> <br />
                <?php
            }else
            {
                ?>
                <a href="<?php echo base_url()?>produccion/revision_fotomecanica/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Producción Fotomecánica"><span style="font-size: 10px;color:red; font-weight: bold;">Producción Fotomecánica</span><i class="icon-film"></i></a> <br />
                <?php
            }
            ?>
           ...
           // }           
            ...
            {
            ?>	
               <a href="<?php echo base_url()?>produccion/bobinado_cartulina/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Bobinado Cartulina"><span style="font-size: 10px;color:green; font-weight: bold;">Bobinado Cartulina</span><i class="icon-film"></i></a><br />		
            <?php
            }
            ?>
	...
	{	   
            ...
            { ?>
               <a href="<?php echo base_url()?>produccion/control_cartulina2/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Control Cartulina 2"><span style="font-size: 10px;color:red; font-weight: bold;">Control Cartulina Respaldo</span><i class="icon-film"></i></a><br />
                <?php
            }else
            { ?>
                <a href="<?php echo base_url()?>produccion/control_cartulina2/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Control Cartulina 2"><span style="font-size: 10px;color:green; font-weight: bold;">Control Cartulina Respaldo</span><i class="icon-film"></i></a><br />
            ...
            {
                ?>
                     <a href="<?php echo base_url()?>produccion/bobinado_liner/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Bobinado Liner"><span style="font-size: 10px;color:green; font-weight: bold;">Bobinado Liner</span><i class="icon-film"></i></a><br />
                <?php
            }
            ?>
                   <a href="<?php echo base_url()?>produccion/control_onda/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Control Onda"><span style="font-size: 10px;color:red; font-weight: bold;">Control Onda</span><i class="icon-film"></i></a><br />
                   <a href="<?php echo base_url()?>produccion/control_liner/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Control Onda"><span style="font-size: 10px;color:red; font-weight: bold;">Control Liner</span><i class="icon-film"></i></a><br />
            ...
            if($fotomecanica2->materialidad_datos_tecnicos != 'Sólo Cartulina')
            {
                ...
                { if($control_onda->estado==0){?>
                   <a href="<?php echo base_url()?>produccion/control_onda/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Control Onda"><span style="font-size: 10px;color:blue; font-weight: bold;">Control Onda</span><i class="icon-film"></i></a><br />
                <?php }else{?>
                   <a href="<?php echo base_url()?>produccion/control_onda/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Control Onda"><span style="font-size: 10px;color:green; font-weight: bold;">Control Onda</span><i class="icon-film"></i></a><br />
                <?php
                }
            }}	
            ?>
            ...
            if($fotomecanica2->materialidad_datos_tecnicos != 'Sólo Cartulina')
            {
                    ...
                    {
                            ?>
                             <a href="<?php echo base_url()?>produccion/bobinado_onda/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Bobinado Onda"><span style="font-size: 10px;color:green; font-weight: bold;">Bobinado Onda</span><i class="icon-film"></i></a><br />
                            <?php
                    }
            }	
            if($fotomecanica2->materialidad_datos_tecnicos != 'Sólo Cartulina')
            {
                    ...
                    {
                            ?>
                            <a href="<?php echo base_url()?>produccion/control_liner/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Control Onda"><span style="font-size: 10px;color:green; font-weight: bold;">Control Liner</span><i class="icon-film"></i></a><br />
                            <?php
                    }
            }
            if($fotomecanica2->materialidad_datos_tecnicos != 'Sólo Cartulina')
            ...
            if($fotomecanica2->materialidad_datos_tecnicos == 'Sólo Cartulina')
            {  ?>
                       <a href="<?php echo base_url()?>produccion/control_onda/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Control Onda"><span style="font-size: 10px;color:black; font-weight: bold;">Control Onda</span><i class="icon-film"></i></a><br />
                       <a href="<?php echo base_url()?>produccion/control_liner/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Control Liner"><span style="font-size: 10px;color:black; font-weight: bold;">Control Liner</span><i class="icon-film"></i></a><br />
                            <?php
            }            
	}// control cartlina
	?>
            ...
            <?php
              if($fotomecanica2->materialidad_datos_tecnicos == 'Cartulina-cartulina')
              {?>
                       <a href="<?php echo base_url()?>produccion/corrugado/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Corrugado"><span style="font-size: 10px;color:black; font-weight: bold;">Corrugado</span><i class="icon-film"></i></a><br />
              <?php 
              }
              else
              { 
		...
		?>	   
            ...
            if($fotomecanica2->materialidad_datos_tecnicos == 'Sólo Cartulina')
            { ?>
                <a href="<?php echo base_url()?>produccion/emplacado/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Emplacado"><span style="font-size: 10px;color:black; font-weight: bold;">Emplacado</span><i class="icon-film"></i></a><br />            <?php
            }
            elseif ($fotomecanica2->materialidad_datos_tecnicos == 'Cartulina-cartulina')
            {
                    ?>
                   <a href="<?php echo base_url()?>produccion/emplacado/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Emplacado"><span style="font-size: 10px;color:black; font-weight: bold;">Emplacado</span><i class="icon-film"></i></a><br />
                    <?php                
            }
            else {                
 ...
 <?php 
            ...
            {
                ?>
               <a href="<?php echo base_url()?>produccion/bodega/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Despacho"><span style="font-size: 10px;color:red; font-weight: bold;">Despacho</span><i class="icon-film"></i></a><br />
                <?php
            }else
            {
                ?>
                <a href="<?php echo base_url()?>produccion/bodega/1/<?php echo $dato->id?>/<?php echo $pagina?>" title="Despacho"><span style="font-size: 10px;color:green; font-weight: bold;">Despacho</span><i class="icon-film"></i></a><br />
