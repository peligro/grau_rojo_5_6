...
?>
<div class="page-header"><h3>Listado de Producción Control Liner ( <?php echo sizeof($datos)?> en total)</h3></div>
<table class="table table-bordered table-striped indice">
    ...
    foreach($datos as $dato)
    {
		...
		$Control_liner=$this->produccion_model->getControlControlLinerPorTipo('1',$dato->id_cotizacion);
		
		$Control_liner_parcial=$this->produccion_model->getParcialControlLinerSuma($dato->id_cotizacion);
		...
		$tapas=$this->materiales_model->getMaterialesPorNombre($fotomecanica->materialidad_3);
		...
		if($fotomecanica->materialidad_datos_tecnicos != 'Sólo Cartulina')
		{
						...
						if($dato->estado == 1 and sizeof($Control_liner)== 0)
						{
						?>	
					...
					if(sizeof($Control_liner) >=1)
						{
					?>		
							
							
							<?php		
										if(sizeof($nop) >=1 and $Control_liner->id_nodo == $nop and $Control_liner->situacion == $Buscar_estado and $dato->id_vendedor == $vendedor)
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 ...
								 <?php 
										 if($Control_liner->situacion == 'Parcial')
										 {
								?>
								...
								?>
							   <td style="width: 20px;"><?php echo 'Control Catulina: '.$Control_liner->fecha_liberada?></td>
								<?php
										 }
								?>
							...
							<?php		
										if($nop == null and $Control_liner->situacion == $Buscar_estado and $dato->id_vendedor == $vendedor)
										{	
							?>
								<td style="width: 20px;"><?php echo 'Prioridad'?></td>
							   ...
							   <td style="width: 20px;"><?php echo 'Control Catulina: '.$Control_liner->fecha_liberada?></td>
								...
								<td style="width: 20px;"><?php echo $Control_liner->total_kilos - $Control_liner_parcial->sum ?></td>
					...
					?>	
							...
							?>
								 ...
								 if(sizeof($Control_liner) >=1)
									{
								 ?>	
								 <td style="width: 20px;"><?php echo $Control_liner->situacion ?></td>
								 <?php
									}
								 ?>
							...
							<?php		
										if($nop == null and $Buscar_estado == 'Pendiente'  and $vendedor == 'Todos'  and sizeof($Control_liner)== 0)
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 <td style="width: 20px;"><?php echo 'Fotomecanica :'.$dato->fecha_liberada?></td>
							...
							<?php		
										if($nop == null and $Buscar_estado == $Control_liner->situacion  and $vendedor == 'Todos')
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 <td style="width: 20px;"><?php echo 'Fotomecanica :'.$dato->fecha_liberada?></td>
							...
							<?php		
										if($nop == $dato->id_op and $Buscar_estado == $Control_liner->situacion  and $vendedor == 'Todos')
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 <td style="width: 20px;"><?php echo 'Fotomecanica :'.$dato->fecha_liberada?></td>
