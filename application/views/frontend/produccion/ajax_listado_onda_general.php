...
<table class="table table-bordered table-striped indice">
    ...
    foreach($datos as $dato)
    {
		...
		$Control_onda=$this->produccion_model->getControlControlOndaPorTipo('1',$dato->id_cotizacion);
		
		$Control_onda_parcial=$this->produccion_model->getParcialControlOndaSuma($dato->id_cotizacion);
		...
		$tapas=$this->materiales_model->getMaterialesPorNombre($fotomecanica->materialidad_2);
		...
		if($fotomecanica->materialidad_datos_tecnicos != 'Sólo Cartulina')
		{
						...
						if($dato->estado == 1 and sizeof($Control_onda)== 0)
						{
						?>	
					...
					if(sizeof($Control_onda) >=1)
						{
					?>		
							
							
							<?php		
										if(sizeof($nop) >=1 and $Control_onda->id_nodo == $nop and $Control_onda->situacion == $Buscar_estado and $dato->id_vendedor == $vendedor)
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 ...
								 <?php 
										 if($Control_onda->situacion == 'Parcial')
										 {
								?>
								...
								?>
							   <td style="width: 20px;"><?php echo 'Control Catulina: '.$Control_onda->fecha_liberada?></td>
								<?php
										 }
								?>
							...
							<?php		
										if($nop == null and $Control_onda->situacion == $Buscar_estado and $dato->id_vendedor == $vendedor)
										{	
							?>
								<td style="width: 20px;"><?php echo 'Prioridad'?></td>
							   ...
							   <td style="width: 20px;"><?php echo 'Control Catulina: '.$Control_onda->fecha_liberada?></td>
								...
								<td style="width: 20px;"><?php echo $Control_onda->total_kilos - $Control_onda_parcial->sum ?></td>
					...
					?>	
							...
							?>
								 ...
								 if(sizeof($Control_onda) >=1)
									{
								 ?>	
								 <td style="width: 20px;"><?php echo $Control_onda->situacion ?></td>
								 <?php
									}
								 ?>
							...
							<?php		
										if($nop == null and $Buscar_estado == 'Pendiente'  and $vendedor == 'Todos'  and sizeof($Control_onda)== 0)
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 <td style="width: 20px;"><?php echo 'Fotomecanica :'.$dato->fecha_liberada?></td>
							...
							<?php		
										if($nop == null and $Buscar_estado == $Control_onda->situacion  and $vendedor == 'Todos')
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 <td style="width: 20px;"><?php echo 'Fotomecanica :'.$dato->fecha_liberada?></td>
							...
							<?php		
										if($nop == $dato->id_op and $Buscar_estado == $Control_onda->situacion  and $vendedor == 'Todos')
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 <td style="width: 20px;"><?php echo 'Fotomecanica :'.$dato->fecha_liberada?></td>
