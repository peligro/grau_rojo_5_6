...
?>
<div class="page-header"><h3>Listado de Producción Control Cartulina ( <?php echo sizeof($datos)?> en total)</h3></div>
<table class="table table-bordered table-striped indice">
    ...
    foreach($datos as $dato)
    {
		...
		$Control_cartulina=$this->produccion_model->getControlCartulinaPorTipo('1',$dato->id_cotizacion);
		//$Control_cartulina_parcial=$this->produccion_model->getControlCartulinaParcialPorTipo('1',$dato->id_op);
		$Control_cartulina_parcial=$this->produccion_model->getParcialControlCartulina($dato->id_cotizacion);
		...
		$tapas=$this->materiales_model->getMaterialesPorNombre($fotomecanica->materialidad_1);
						...
						if($dato->estado == 1 and sizeof($Control_cartulina)== 0)
						{
						?>	
					...
					?>		
							...
							<?php		
										if(sizeof($nop) >=1 and $Control_cartulina->id_nodo == $nop and $Control_cartulina->situacion == $Buscar_estado and $dato->id_vendedor == $vendedor)
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 ...
								 <?php 
										 if($Control_cartulina->situacion == 'Parcial')
										 {
								?>
								...
								?>
							   <td style="width: 20px;"><?php echo 'Control Catulina: '.$Control_cartulina->fecha_liberada?></td>
								<?php
										 }
								?>
							...
							<?php		
										if($nop == null and $Control_cartulina->situacion == $Buscar_estado and $dato->id_vendedor == $vendedor)
										{	
							?>
								<td style="width: 20px;"><?php echo 'Prioridad'?></td>
							   ...
							   <td style="width: 20px;"><?php echo 'Control Catulina: '.$Control_cartulina->fecha_liberada?></td>
								...
								<td style="width: 20px;"><?php echo $Control_cartulina->total_kilos - $Control_cartulina_parcial->sum ?></td>
					...
					?>	
							...
							?>
								 ...
								 if(sizeof($Control_cartulina) >=1)
									{
								 ?>	
								 <td style="width: 20px;"><?php echo $Control_cartulina->situacion ?></td>
								 <?php
									}
								 ?>
							...
							<?php		
										if($nop == null and $Buscar_estado == 'Pendiente'  and $vendedor == 'Todos'  and sizeof($Control_cartulina)== 0)
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 <td style="width: 20px;"><?php echo 'Fotomecanica :'.$dato->fecha_liberada?></td>
							...
							<?php		
										if($nop == null and $Buscar_estado == $Control_cartulina->situacion  and $vendedor == 'Todos')
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 <td style="width: 20px;"><?php echo 'Fotomecanica :'.$dato->fecha_liberada?></td>
							...
							<?php		
										if($nop == $dato->id_op and $Buscar_estado == $Control_cartulina->situacion  and $vendedor == 'Todos')
										{	
							?>
								 <td style="width: 20px;"><?php echo 'Prioridad'?></td>
								 <td style="width: 20px;"><?php echo 'Fotomecanica :'.$dato->fecha_liberada?></td>
