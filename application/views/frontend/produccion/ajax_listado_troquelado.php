...
//->select("usu.nombre,cli.razon_social,ppp.cuando,op.id as id_op,op.nombre_producto_normal,
//ppp.total_o_parcial,ppp.can_despacho_1,ppp.can_despacho_2,ppp.can_despacho_3,ppp.numero_molde_troquel,ppp.total_pliegos_a_troquelar")
?>
<div class="page-header"><h3>Listado de Producción Troquelado( <?php echo sizeof($datos)?> en total)</h3></div>
<table class="table table-bordered table-striped indice">
    ...
    ?>
		 ...
		 <td style="width: 20px;"><?php echo $dato->total_pliegos_a_troquelar?></td>
