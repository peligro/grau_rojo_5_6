 ...
 if($this->session->userdata('id'))
        {
            ...
            $porpagina=10;
			$datos=$this->produccion_model->getCorteCartulinaEstadoConCotizacionPaginacion($pagina,$porpagina,"limit");
			$cuantos=$this->produccion_model->getCorteCartulinaEstadoConCotizacionPaginacion($pagina,$porpagina,"cuantos");
...
?>
<div class="page-header"><h3>Listado de Producción Corte Cartulina Estado( <?php echo sizeof($datos)?> en total)</h3></div>
<table class="table table-bordered table-striped indice">
	<thead>
		<tr>
			   ...
			   <th>Detalle</th>			   
			   <th>Fecha OP</th>
			   <th>Descripcion Cartulina</th>			  
			   <th>Gramaje Cartulina</th>
			   <th>Ancho</th>
...
$hayparcial=$this->produccion_model->getParcialCorteCartulinaLiner($dato->id_nodo);		
    ...
    ?>
		<td style="width: 6000px;">Prioridad</td>
		 ...
		 <td style="width: 20px;"><?php echo ''?></td>
		 <td style="width: 20px;"><?php echo $dato->ancho_bobina?></td>
		 <td style="width: 20px;"><?php echo $dato->largo_a_cortar?></td>
