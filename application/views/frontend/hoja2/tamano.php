...
<?php echo form_open_multipart(null, array('class' => 'form-horizontal','name'=>'form','id'=>'form')); ?>
    ...
    <div class="control-group">
		...
		<div class="controls">
			<input type="text" name="ancho" value="<?php echo $ing->tamano_a_imprimir_1?>" onkeypress="return soloNumeros(event)" />
		</div>
	</div>
    <div class="control-group">
		<label class="control-label" for="usuario">Largo</label>
		<div class="controls">
			<input type="text" name="largo" value="<?php echo $ing->tamano_a_imprimir_2?>" onkeypress="return soloNumeros(event)" />
		</div>
	</div>
     <div class="control-group">
