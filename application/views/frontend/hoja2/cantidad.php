...
<?php echo form_open_multipart(null, array('class' => 'form-horizontal','name'=>'form','id'=>'form')); ?>
    ...
    <div class="control-group">
		<label class="control-label" for="usuario">Cantidad 1</label>
		<div class="controls">
			<input type="text" name="cantidad_1" value="<?php echo $datos->cantidad_1?>" onkeypress="return soloNumeros(event)" />
		</div>
	</div>
     <div class="control-group">
