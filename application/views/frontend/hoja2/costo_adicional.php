...
<?php echo form_open_multipart(null, array('class' => 'form-horizontal','name'=>'form','id'=>'form')); ?>
    ...
    <div class="control-group">
		<label class="control-label" for="usuario">Costo Adicional</label>
		<div class="controls">
			<input type="text" name="costo_adicional" value="<?php echo $hoja->costo_adicional?>" onkeypress="return soloNumeros(event)" />
		</div>
	</div>
     <div class="control-group">
